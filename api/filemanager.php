...
// Events
require_once '../vendor/hkvstore/richfilemanager/connectors/php/events.php';
...
$config = [
    'options' => [
        'fileRoot' => UploadPath(true),
        'serverRoot' => false // Use 'fileRoot' as documentRoot
    ]
];
...
// setup files root folder
$userFilesPath = "userfiles";
if (!IsAdmin()) {
    $userFilesPath .= "/" . rawurlencode(CurrentUserName());
}
if ($userFilesPath) {
    $local->setRoot($userFilesPath, true, true);
}
