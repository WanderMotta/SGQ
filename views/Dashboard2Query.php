...
// Dashboard modal query object
$Dashboard2Search = $Page;
$Dashboard2Search->UseAjaxActions = false;
$Dashboard2Search->IsModal = true;
?>
<script>
...
<?= $Page->IsModal ? '<template class="ew-modal-buttons">' : '<div class="row ew-buttons">' ?><!-- buttons .row -->
    <div class="<?= $Page->OffsetColumnClass ?>"><!-- buttons offset -->
        ...
        <?php if ($Page->IsModal) { ?>
        <button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fDashboard2search"><?= $Language->phrase("Cancel") ?></button>
        <?php } else { ?>
