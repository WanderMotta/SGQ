...
// Page object
$ProcessoIndicadoresPreview = &$Page;
?>
<script>
ew.deepAssign(ew.vars, { tables: { processo_indicadores: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<script>
...
<?php if ($Page->indicadores_idindicadores->Visible) { // indicadores_idindicadores ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->indicadores_idindicadores->headerCellClass() ?>"><div role="button" data-table="processo_indicadores" data-sort="<?= HtmlEncode($Page->indicadores_idindicadores->Name) ?>" data-sort-type="2" data-sort-order="<?= $Page->indicadores_idindicadores->getNextSort() ?>">
