...
// Page object
$RelatorioAuditoriaInternaAdd = &$Page;
?>
<script>
...
var currentForm;
var frelatorio_auditoria_internaadd;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("frelatorio_auditoria_internaadd")
        .setPageId("add")
...
$Page->showMessage();
?>
<form name="frelatorio_auditoria_internaadd" id="frelatorio_auditoria_internaadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<script>
loadjs.ready(["frelatorio_auditoria_internaadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("frelatorio_auditoria_internaadd", "x_data", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_relatorio_auditoria_interna_origem_risco_oportunidade_idorigem_risco_oportunidade">
    <select
        ...
        data-select2-id="frelatorio_auditoria_internaadd_x_origem_risco_oportunidade_idorigem_risco_oportunidade"
...
<script>
loadjs.ready("frelatorio_auditoria_internaadd", function() {
    var options = { name: "x_origem_risco_oportunidade_idorigem_risco_oportunidade", selectId: "frelatorio_auditoria_internaadd_x_origem_risco_oportunidade_idorigem_risco_oportunidade" };
    if (frelatorio_auditoria_internaadd.lists.origem_risco_oportunidade_idorigem_risco_oportunidade?.lookupOptions.length) {
        options.data = { id: "x_origem_risco_oportunidade_idorigem_risco_oportunidade", form: "frelatorio_auditoria_internaadd" };
    } else {
        options.ajax = { id: "x_origem_risco_oportunidade_idorigem_risco_oportunidade", form: "frelatorio_auditoria_internaadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_relatorio_auditoria_interna_auditor">
    <select
        ...
        data-select2-id="frelatorio_auditoria_internaadd_x_auditor"
        data-table="relatorio_auditoria_interna"
...
<script>
loadjs.ready("frelatorio_auditoria_internaadd", function() {
    var options = { name: "x_auditor", selectId: "frelatorio_auditoria_internaadd_x_auditor" };
    if (frelatorio_auditoria_internaadd.lists.auditor?.lookupOptions.length) {
        options.data = { id: "x_auditor", form: "frelatorio_auditoria_internaadd" };
    } else {
        options.ajax = { id: "x_auditor", form: "frelatorio_auditoria_internaadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_relatorio_auditoria_interna_aprovador">
    <select
        ...
        data-select2-id="frelatorio_auditoria_internaadd_x_aprovador"
        data-table="relatorio_auditoria_interna"
...
<script>
loadjs.ready("frelatorio_auditoria_internaadd", function() {
    var options = { name: "x_aprovador", selectId: "frelatorio_auditoria_internaadd_x_aprovador" };
    if (frelatorio_auditoria_internaadd.lists.aprovador?.lookupOptions.length) {
        options.data = { id: "x_aprovador", form: "frelatorio_auditoria_internaadd" };
    } else {
        options.ajax = { id: "x_aprovador", form: "frelatorio_auditoria_internaadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<?php
    if (in_array("item_rel_aud_interna", explode(",", $Page->getCurrentDetailTable())) && $item_rel_aud_interna->DetailAdd) {
?>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="frelatorio_auditoria_internaadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="frelatorio_auditoria_internaadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
