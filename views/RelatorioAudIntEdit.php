...
?>
<main class="edit">
<form name="frelatorio_aud_intedit" id="frelatorio_aud_intedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { relatorio_aud_int: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var frelatorio_aud_intedit;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("frelatorio_aud_intedit")
        .setPageId("edit")

        // Add fields
        .setFields([
            ["idrelatorio_aud_int", [fields.idrelatorio_aud_int.visible && fields.idrelatorio_aud_int.required ? ew.Validators.required(fields.idrelatorio_aud_int.caption) : null], fields.idrelatorio_aud_int.isInvalid],
...
<?php if ($Page->idrelatorio_aud_int->Visible) { // idrelatorio_aud_int ?>
    <div id="r_idrelatorio_aud_int"<?= $Page->idrelatorio_aud_int->rowAttributes() ?>>
        <label id="elh_relatorio_aud_int_idrelatorio_aud_int" class="<?= $Page->LeftColumnClass ?>"><?= $Page->idrelatorio_aud_int->caption() ?><?= $Page->idrelatorio_aud_int->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div<?= $Page->idrelatorio_aud_int->cellAttributes() ?>>
<span id="el_relatorio_aud_int_idrelatorio_aud_int">
<span<?= $Page->idrelatorio_aud_int->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?= HtmlEncode(RemoveHtml($Page->idrelatorio_aud_int->getDisplayValue($Page->idrelatorio_aud_int->EditValue))) ?>"></span>
<input type="hidden" data-table="relatorio_aud_int" data-field="x_idrelatorio_aud_int" data-hidden="1" name="x_idrelatorio_aud_int" id="x_idrelatorio_aud_int" value="<?= HtmlEncode($Page->idrelatorio_aud_int->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<span id="el_relatorio_aud_int_plano_auditoria_int_idplano_auditoria_int">
    <select
        ...
        data-select2-id="frelatorio_aud_intedit_x_plano_auditoria_int_idplano_auditoria_int"
...
<script>
loadjs.ready("frelatorio_aud_intedit", function() {
    var options = { name: "x_plano_auditoria_int_idplano_auditoria_int", selectId: "frelatorio_aud_intedit_x_plano_auditoria_int_idplano_auditoria_int" };
    if (frelatorio_aud_intedit.lists.plano_auditoria_int_idplano_auditoria_int?.lookupOptions.length) {
        options.data = { id: "x_plano_auditoria_int_idplano_auditoria_int", form: "frelatorio_aud_intedit" };
    } else {
        options.ajax = { id: "x_plano_auditoria_int_idplano_auditoria_int", form: "frelatorio_aud_intedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_relatorio_aud_int_item_plano_aud_int_iditem_plano_aud_int">
    <select
        ...
        data-select2-id="frelatorio_aud_intedit_x_item_plano_aud_int_iditem_plano_aud_int"
        data-table="relatorio_aud_int"
...
<script>
loadjs.ready("frelatorio_aud_intedit", function() {
    var options = { name: "x_item_plano_aud_int_iditem_plano_aud_int", selectId: "frelatorio_aud_intedit_x_item_plano_aud_int_iditem_plano_aud_int" };
    if (frelatorio_aud_intedit.lists.item_plano_aud_int_iditem_plano_aud_int?.lookupOptions.length) {
        options.data = { id: "x_item_plano_aud_int_iditem_plano_aud_int", form: "frelatorio_aud_intedit" };
    } else {
        options.ajax = { id: "x_item_plano_aud_int_iditem_plano_aud_int", form: "frelatorio_aud_intedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="frelatorio_aud_intedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="frelatorio_aud_intedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
