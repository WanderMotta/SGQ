...
<?php } ?>
<?php if (!$Page->IsModal) { ?>
<form name="fusuariosrch" id="fusuariosrch" class="ew-form ew-ext-search-form" action="<?= CurrentPageUrl(false) ?>" novalidate autocomplete="off">
...
<?php if ($Page->nome->Visible) { // nome ?>
        <th data-name="nome" class="<?= $Page->nome->headerCellClass() ?>"><div id="elh_usuario_nome" class="usuario_nome"><?= $Page->renderFieldHeader($Page->nome) ?></div></th>
<?php } ?>
<?php if ($Page->_login->Visible) { // login ?>
        <th data-name="_login" class="<?= $Page->_login->headerCellClass() ?>"><div id="elh_usuario__login" class="usuario__login"><?= $Page->renderFieldHeader($Page->_login) ?></div></th>
<?php } ?>
<?php if ($Page->senha->Visible) { // senha ?>
        <th data-name="senha" class="<?= $Page->senha->headerCellClass() ?>"><div id="elh_usuario_senha" class="usuario_senha"><?= $Page->renderFieldHeader($Page->senha) ?></div></th>
<?php } ?>
<?php if ($Page->status->Visible) { // status ?>
        <th data-name="status" class="<?= $Page->status->headerCellClass() ?>"><div id="elh_usuario_status" class="usuario_status"><?= $Page->renderFieldHeader($Page->status) ?></div></th>
<?php } ?>
<?php if ($Page->ativo->Visible) { // ativo ?>
        <th data-name="ativo" class="<?= $Page->ativo->headerCellClass() ?>"><div id="elh_usuario_ativo" class="usuario_ativo"><?= $Page->renderFieldHeader($Page->ativo) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_usuario_nome" class="el_usuario_nome">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_usuario__login" class="el_usuario__login">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_usuario_senha" class="el_usuario_senha">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_usuario_status" class="el_usuario_status">
...
<span id="el<?= $Page->RowIndex == '$rowindex$' ? '$rowindex$' : $Page->RowCount ?>_usuario_ativo" class="el_usuario_ativo">
