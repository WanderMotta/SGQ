...
/**
 * rel_processos controller
 */
class RelProcessosController extends ControllerBase
{
    // summary
    #[Map(["GET", "POST", "OPTIONS"], "/RelProcessos", [PermissionMiddleware::class], "summary.rel_processos")]
    public function summary(Request $request, Response $response, array $args): Response
    {
        return $this->runPage($request, $response, $args, "RelProcessosSummary");
    }
}
