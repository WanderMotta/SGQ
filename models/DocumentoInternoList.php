 ...
 * Page class
 */
class DocumentoInternoList extends DocumentoInterno
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentoInternoList";
    ...
    public $FormName = "fdocumento_internolist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "DocumentoInternoList";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "DocumentoInternoAdd?" . Config("TABLE_SHOW_DETAIL") . "=";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "DocumentoInternoDelete";
        $this->MultiUpdateUrl = "DocumentoInternoUpdate";
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fdocumento_internogrid";
        }
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->iddocumento_interno->AdvancedSearch->toJson(), ","); // Field iddocumento_interno
        ...
        $filterList = Concat($filterList, $this->categoria_documento_idcategoria_documento->AdvancedSearch->toJson(), ","); // Field categoria_documento_idcategoria_documento
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fdocumento_internosrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field iddocumento_interno
        $this->iddocumento_interno->AdvancedSearch->SearchValue = @$filter["x_iddocumento_interno"];
        $this->iddocumento_interno->AdvancedSearch->SearchOperator = @$filter["z_iddocumento_interno"];
        $this->iddocumento_interno->AdvancedSearch->SearchCondition = @$filter["v_iddocumento_interno"];
        $this->iddocumento_interno->AdvancedSearch->SearchValue2 = @$filter["y_iddocumento_interno"];
        $this->iddocumento_interno->AdvancedSearch->SearchOperator2 = @$filter["w_iddocumento_interno"];
        $this->iddocumento_interno->AdvancedSearch->save();
        ...
        // Field categoria_documento_idcategoria_documento
        $this->categoria_documento_idcategoria_documento->AdvancedSearch->SearchValue = @$filter["x_categoria_documento_idcategoria_documento"];
        $this->categoria_documento_idcategoria_documento->AdvancedSearch->SearchOperator = @$filter["z_categoria_documento_idcategoria_documento"];
        $this->categoria_documento_idcategoria_documento->AdvancedSearch->SearchCondition = @$filter["v_categoria_documento_idcategoria_documento"];
        $this->categoria_documento_idcategoria_documento->AdvancedSearch->SearchValue2 = @$filter["y_categoria_documento_idcategoria_documento"];
        $this->categoria_documento_idcategoria_documento->AdvancedSearch->SearchOperator2 = @$filter["w_categoria_documento_idcategoria_documento"];
        $this->categoria_documento_idcategoria_documento->AdvancedSearch->save();
    ...
    public function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->iddocumento_interno, $default, false); // iddocumento_interno
        ...
        $this->buildSearchSql($where, $this->categoria_documento_idcategoria_documento, $default, false); // categoria_documento_idcategoria_documento
        ...
        if (!$default && $this->Command == "search") {
            $this->iddocumento_interno->AdvancedSearch->save(); // iddocumento_interno
            ...
            $this->categoria_documento_idcategoria_documento->AdvancedSearch->save(); // categoria_documento_idcategoria_documento
    ...
    public function showFilterList()
    {
        ...
        // Field iddocumento_interno
        $filter = $this->queryBuilderWhere("iddocumento_interno");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->iddocumento_interno, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->iddocumento_interno->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }
        ...
        // Field categoria_documento_idcategoria_documento
        $filter = $this->queryBuilderWhere("categoria_documento_idcategoria_documento");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->categoria_documento_idcategoria_documento, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->categoria_documento_idcategoria_documento->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->iddocumento_interno->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->categoria_documento_idcategoria_documento->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    {
        $this->iddocumento_interno->AdvancedSearch->unsetSession();
        ...
        $this->categoria_documento_idcategoria_documento->AdvancedSearch->unsetSession();
    ...
    protected function setupSortOrder()
    {
        ...
        if ($this->Command != "json") {
            $defaultSort = $this->iddocumento_interno->Expression . " DESC"; // Set up default sort
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->iddocumento_interno, $ctrl); // iddocumento_interno
            $this->updateSort($this->titulo_documento, $ctrl); // titulo_documento
            $this->updateSort($this->restringir_acesso, $ctrl); // restringir_acesso
            $this->updateSort($this->categoria_documento_idcategoria_documento, $ctrl); // categoria_documento_idcategoria_documento
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->categoria_documento_idcategoria_documento->setSort("");
    ...
    protected function setupListOptions()
    {
        ...
        // "detail_revisao_documento"
        $item = &$this->ListOptions->add("detail_revisao_documento");
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'revisao_documento');
        $item->OnLeft = true;
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"documento_interno\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"documento_interno\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"documento_interno\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fdocumento_internolist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fdocumento_internolist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        // "detail_revisao_documento"
        $opt = $this->ListOptions["detail_revisao_documento"];
        if ($Security->allowList(CurrentProjectID() . 'revisao_documento')) {
            $body = $Language->phrase("DetailLink") . $Language->tablePhrase("revisao_documento", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail" . ($this->ListOptions->UseDropDownButton ? " dropdown-toggle" : "") . "\" data-action=\"list\" href=\"" . HtmlEncode("RevisaoDocumentoList?" . Config("TABLE_SHOW_MASTER") . "=documento_interno&" . GetForeignKeyUrl("fk_iddocumento_interno", $this->iddocumento_interno->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("RevisaoDocumentoGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'documento_interno')) {
                $caption = $Language->phrase("MasterDetailViewLink", null);
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=revisao_documento");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a></li>";
                if ($detailViewTblVar != "") {
                    $detailViewTblVar .= ",";
                }
                $detailViewTblVar .= "revisao_documento";
            }
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'documento_interno')) {
                $caption = $Language->phrase("MasterDetailEditLink", null);
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=revisao_documento");
                ...
                $detailEditTblVar .= "revisao_documento";
            }
            if ($detailPage->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'documento_interno')) {
                $caption = $Language->phrase("MasterDetailCopyLink", null);
                $url = $this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=revisao_documento");
                ...
                $detailCopyTblVar .= "revisao_documento";
            }
            if ($links != "") {
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->iddocumento_interno->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"documento_interno\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $detailTableLink = "";
        $item = &$option->add("detailadd_revisao_documento");
        $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=revisao_documento");
        $detailPage = Container("RevisaoDocumentoGrid");
        $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
        $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
        $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'documento_interno') && $Security->canAdd());
        if ($item->Visible) {
            if ($detailTableLink != "") {
                $detailTableLink .= ",";
            }
            $detailTableLink .= "revisao_documento";
        }
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "iddocumento_interno");
            $this->createColumnOption($option, "titulo_documento");
            $this->createColumnOption($option, "restringir_acesso");
            $this->createColumnOption($option, "categoria_documento_idcategoria_documento");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fdocumento_internosrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fdocumento_internosrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fdocumento_internolist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_documento_interno", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_documento_interno",
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->iddocumento_interno->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->iddocumento_interno->AdvancedSearch->SearchValue != "" || $this->iddocumento_interno->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->categoria_documento_idcategoria_documento->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->categoria_documento_idcategoria_documento->AdvancedSearch->SearchValue != "" || $this->categoria_documento_idcategoria_documento->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if (!$this->isExport()) {
                $this->iddocumento_interno->ViewValue = $this->highlightValue($this->iddocumento_interno);
            }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fdocumento_internolist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fdocumento_internosrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
        ...
        if ($this->ModalSearch && !IsMobile()) {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch", true) . "\" data-table=\"documento_interno\" data-caption=\"" . $Language->phrase("AdvancedSearch", true) . "\" data-ew-action=\"modal\" data-url=\"DocumentoInternoSearch\" data-btn=\"SearchBtn\">" . $Language->phrase("AdvancedSearch", false) . "</a>";
        } else {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch", true) . "\" data-caption=\"" . $Language->phrase("AdvancedSearch", true) . "\" href=\"DocumentoInternoSearch\">" . $Language->phrase("AdvancedSearch", false) . "</a>";
        }
        $item->Visible = true;

        // Search highlight button
        $item = &$this->SearchOptions->add("searchhighlight");
        $item->Body = "<a class=\"btn btn-default ew-highlight active\" role=\"button\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-ew-action=\"highlight\" data-form=\"fdocumento_internosrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</a>";
