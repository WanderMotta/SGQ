...
class UsuarioView extends Usuario
{
    ...
    // CSS class/style
    public $CurrentPageName = "UsuarioView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idusuario") ?? Route("idusuario")) !== null) {
            $this->RecKey["idusuario"] = $keyValue;
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idusuario->CurrentValue, $this->CurrentRow['idusuario'])) {
