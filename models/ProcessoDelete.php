 ...
 * Page class
 */
class ProcessoDelete extends Processo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProcessoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ProcessoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProcessoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ProcessoList"); // Return to list
                return;
            }
        }
