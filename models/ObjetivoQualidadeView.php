 ...
 * Page class
 */
class ObjetivoQualidadeView extends ObjetivoQualidade
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ObjetivoQualidadeView";
    ...
    // CSS class/style
    public $CurrentPageName = "ObjetivoQualidadeView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idobjetivo_qualidade") ?? Route("idobjetivo_qualidade")) !== null) {
            $this->RecKey["idobjetivo_qualidade"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idobjetivo_qualidade") ?? Route("idobjetivo_qualidade")) !== null) {
            ...
            $this->RecKey["idobjetivo_qualidade"] = $this->idobjetivo_qualidade->QueryStringValue;
        } elseif (Post("idobjetivo_qualidade") !== null) {
            $this->idobjetivo_qualidade->setFormValue(Post("idobjetivo_qualidade"));
            $this->RecKey["idobjetivo_qualidade"] = $this->idobjetivo_qualidade->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idobjetivo_qualidade->setQueryStringValue($keyValue);
            $this->RecKey["idobjetivo_qualidade"] = $this->idobjetivo_qualidade->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ObjetivoQualidadeList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ObjetivoQualidadeList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idobjetivo_qualidade->CurrentValue, $this->CurrentRow['idobjetivo_qualidade'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ObjetivoQualidadeList"; // No matching record, return to list
                    } else {
