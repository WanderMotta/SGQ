 ...
 * Page class
 */
class ItemPlanoAudIntPreview extends ItemPlanoAudInt
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemPlanoAudIntPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ItemPlanoAudIntPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "plano_auditoria_int") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=plano_auditoria_int&" . GetForeignKeyUrl("fk_idplano_auditoria_int", $this->plano_auditoria_int_idplano_auditoria_int->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "plano_auditoria_int") {
            $this->plano_auditoria_int_idplano_auditoria_int->setQueryStringValue($keys[0] ?? "");
        }
    }
