 ...
 * Page class
 */
class ProcessoIndicadoresSearch extends ProcessoIndicadores
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProcessoIndicadoresSearch";
    ...
    // CSS class/style
    public $CurrentPageName = "ProcessoIndicadoresSearch";
    ...
    public function run()
    {
        ...
        if ($this->isSearch()) {
            ...
            if ($srchStr != "") {
                $srchStr = "ProcessoIndicadoresList" . "?" . $srchStr;
    ...
    {
        $srchUrl = "";
        $this->buildSearchUrl($srchUrl, $this->idprocesso_indicadores); // idprocesso_indicadores
        $this->buildSearchUrl($srchUrl, $this->processo_idprocesso); // processo_idprocesso
        $this->buildSearchUrl($srchUrl, $this->indicadores_idindicadores); // indicadores_idindicadores
        if ($srchUrl != "") {
            $srchUrl .= "&";
        }
        $srchUrl .= "cmd=search";
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->idprocesso_indicadores->EditValue = $this->idprocesso_indicadores->AdvancedSearch->SearchValue;
            $this->idprocesso_indicadores->PlaceHolder = RemoveHtml($this->idprocesso_indicadores->caption());
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->idprocesso_indicadores->AdvancedSearch->SearchValue)) {
            $this->idprocesso_indicadores->addErrorMessage($this->idprocesso_indicadores->getErrorMessage(false));
        }
