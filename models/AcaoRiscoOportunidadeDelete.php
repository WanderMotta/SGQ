 ...
 * Page class
 */
class AcaoRiscoOportunidadeDelete extends AcaoRiscoOportunidade
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AcaoRiscoOportunidadeDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AcaoRiscoOportunidadeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AcaoRiscoOportunidadeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("AcaoRiscoOportunidadeList"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['idacao_risco_oportunidade'];
