 ...
 * Page class
 */
class PlanoAcaoPreview extends PlanoAcao
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanoAcaoPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "PlanoAcaoPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "risco_oportunidade") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=risco_oportunidade&" . GetForeignKeyUrl("fk_idrisco_oportunidade", $this->risco_oportunidade_idrisco_oportunidade->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "risco_oportunidade") {
            $this->risco_oportunidade_idrisco_oportunidade->setQueryStringValue($keys[0] ?? "");
        }
    }
