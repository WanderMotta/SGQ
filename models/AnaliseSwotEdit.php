 ...
 * Page class
 */
class AnaliseSwotEdit extends AnaliseSwot
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AnaliseSwotEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "AnaliseSwotEdit";
    ...
    {
        $this->idanalise_swot->setVisibility();
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("idanalise_swot") ?? Key(0) ?? Route(2)) !== null) {
                $this->idanalise_swot->setQueryStringValue($keyValue);
                $this->idanalise_swot->setOldValue($this->idanalise_swot->QueryStringValue);
            } elseif (Post("idanalise_swot") !== null) {
                $this->idanalise_swot->setFormValue(Post("idanalise_swot"));
                $this->idanalise_swot->setOldValue($this->idanalise_swot->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                if (($keyValue = Get("idanalise_swot") ?? Route("idanalise_swot")) !== null) {
                    ...
                    $this->idanalise_swot->CurrentValue = null;
                }
            }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->idanalise_swot->IsDetailKey) {
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            if ($this->idanalise_swot->Visible && $this->idanalise_swot->Required) {
                if (!$this->idanalise_swot->IsDetailKey && EmptyValue($this->idanalise_swot->FormValue)) {
                    $this->idanalise_swot->addErrorMessage(str_replace("%s", $this->idanalise_swot->caption(), $this->idanalise_swot->RequiredErrorMessage));
                }
            }
    ...
    protected function getEditRow($rsold)
    {
        ...
        // contexto_idcontexto
        if ($this->contexto_idcontexto->getSessionValue() != "") {
            $this->contexto_idcontexto->ReadOnly = true;
        }
        $this->contexto_idcontexto->setDbValueDef($rsnew, $this->contexto_idcontexto->CurrentValue, $this->contexto_idcontexto->ReadOnly);
        return $rsnew;
    }
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['contexto_idcontexto'])) { // contexto_idcontexto
            $this->contexto_idcontexto->CurrentValue = $row['contexto_idcontexto'];
        }
    }
