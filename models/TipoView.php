...
class TipoView extends Tipo
{
    ...
    // CSS class/style
    public $CurrentPageName = "TipoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idtipo") ?? Route("idtipo")) !== null) {
            ...
            $this->RecKey["idtipo"] = $this->idtipo->QueryStringValue;
        } elseif (Post("idtipo") !== null) {
            $this->idtipo->setFormValue(Post("idtipo"));
            $this->RecKey["idtipo"] = $this->idtipo->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idtipo->setQueryStringValue($keyValue);
            $this->RecKey["idtipo"] = $this->idtipo->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "TipoList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("TipoList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idtipo->CurrentValue, $this->CurrentRow['idtipo'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "TipoList"; // No matching record, return to list
                    } else {
