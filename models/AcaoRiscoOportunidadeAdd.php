 ...
 * Page class
 */
class AcaoRiscoOportunidadeAdd extends AcaoRiscoOportunidade
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AcaoRiscoOportunidadeAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "AcaoRiscoOportunidadeAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "AcaoRiscoOportunidadeView") {
    ...
    protected function getAddRow()
    {
        ...
        // acao
        $this->acao->setDbValueDef($rsnew, $this->acao->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['acao'])) { // acao
            $this->acao->setFormValue($row['acao']);
        }
