 ...
 * Page class
 */
class ProcessoIndicadoresGrid extends ProcessoIndicadores
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProcessoIndicadoresGrid";
    ...
    public $FormName = "fprocesso_indicadoresgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ProcessoIndicadoresGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->idprocesso_indicadores->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->idprocesso_indicadores->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['idprocesso_indicadores'];
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "processo") {
            $this->processo_idprocesso->Visible = true; // Need to insert foreign key
            $this->processo_idprocesso->CurrentValue = $this->processo_idprocesso->getSessionValue();
        }
        ...
        // Check referential integrity for master table 'processo_indicadores'
        $validMasterRecord = true;
        $detailKeys = [];
        $detailKeys["processo_idprocesso"] = $this->processo_idprocesso->getSessionValue();
        $masterTable = Container("processo");
        $masterFilter = $this->getMasterFilter($masterTable, $detailKeys);
        if (!EmptyValue($masterFilter)) {
            $rsmaster = $masterTable->loadRs($masterFilter)->fetch();
    ...
    protected function getAddRow()
    {
        ...
        if ($this->processo_idprocesso->getSessionValue() != "") {
            $rsnew['processo_idprocesso'] = $this->processo_idprocesso->getSessionValue();
        }
        return $rsnew;
    }
