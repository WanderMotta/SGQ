 ...
 * Page class
 */
class GraficosDelete extends Graficos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GraficosDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "GraficosDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("GraficosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("GraficosList"); // Return to list
                return;
            }
        }
