 ...
 * Page class
 */
class ItemPlanoAudIntDelete extends ItemPlanoAudInt
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemPlanoAudIntDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ItemPlanoAudIntDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ItemPlanoAudIntList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ItemPlanoAudIntList"); // Return to list
                return;
            }
        }
