 ...
 * Page class
 */
class DocumentoRegistroEdit extends DocumentoRegistro
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentoRegistroEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentoRegistroEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("iddocumento_registro") ?? Key(0) ?? Route(2)) !== null) {
                $this->iddocumento_registro->setQueryStringValue($keyValue);
                $this->iddocumento_registro->setOldValue($this->iddocumento_registro->QueryStringValue);
            } elseif (Post("iddocumento_registro") !== null) {
                $this->iddocumento_registro->setFormValue(Post("iddocumento_registro"));
                $this->iddocumento_registro->setOldValue($this->iddocumento_registro->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                if (($keyValue = Get("iddocumento_registro") ?? Route("iddocumento_registro")) !== null) {
                    ...
                    $this->iddocumento_registro->CurrentValue = null;
                }
            }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->iddocumento_registro->IsDetailKey) {
            $this->iddocumento_registro->setFormValue($val);
        }
    ...
    {
        global $CurrentForm;
        $this->iddocumento_registro->CurrentValue = $this->iddocumento_registro->FormValue;
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            if ($this->iddocumento_registro->Visible && $this->iddocumento_registro->Required) {
                if (!$this->iddocumento_registro->IsDetailKey && EmptyValue($this->iddocumento_registro->FormValue)) {
                    $this->iddocumento_registro->addErrorMessage(str_replace("%s", $this->iddocumento_registro->caption(), $this->iddocumento_registro->RequiredErrorMessage));
                }
            }
    ...
    protected function getEditRow($rsold)
    {
        ...
        // categoria_documento_idcategoria_documento
        $this->categoria_documento_idcategoria_documento->setDbValueDef($rsnew, $this->categoria_documento_idcategoria_documento->CurrentValue, $this->categoria_documento_idcategoria_documento->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['categoria_documento_idcategoria_documento'])) { // categoria_documento_idcategoria_documento
            $this->categoria_documento_idcategoria_documento->CurrentValue = $row['categoria_documento_idcategoria_documento'];
        }
