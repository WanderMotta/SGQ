 ...
 * Page class
 */
class RevisaoDocumentoPreview extends RevisaoDocumento
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RevisaoDocumentoPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "RevisaoDocumentoPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "documento_interno") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=documento_interno&" . GetForeignKeyUrl("fk_iddocumento_interno", $this->documento_interno_iddocumento_interno->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "documento_interno") {
            $this->documento_interno_iddocumento_interno->setQueryStringValue($keys[0] ?? "");
        }
    }
