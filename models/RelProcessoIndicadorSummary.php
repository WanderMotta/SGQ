 ...
 * Page class
 */
class RelProcessoIndicadorSummary extends RelProcessoIndicador
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RelProcessoIndicadorSummary";
    ...
    public $CurrentPageName = "RelProcessoIndicador";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'rel_processo_indicador';
        $this->TableName = 'rel_processo_indicador';
        ...
        // Table object (rel_processo_indicador)
        if (!isset($GLOBALS["rel_processo_indicador"]) || $GLOBALS["rel_processo_indicador"]::class == PROJECT_NAMESPACE . "rel_processo_indicador") {
            $GLOBALS["rel_processo_indicador"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'rel_processo_indicador');
        }
    ...
    public function loadRowValues($record)
    {
        ...
        $data["indicador"] = $record['indicador'];
        $data["periodicidade"] = $record['periodicidade'];
        $data["unidade"] = $record['unidade'];
        $data["meta"] = $record['meta'];
        $this->Rows[] = $data;
        $this->processo->setDbValue(GroupValue($this->processo, $record['processo']));
        $this->indicador->setDbValue($record['indicador']);
        $this->periodicidade->setDbValue($record['periodicidade']);
        $this->unidade->setDbValue($record['unidade']);
        $this->meta->setDbValue($record['meta']);
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::SEARCH) { // Search row
            ...
            // processo
            $this->processo->GroupViewValue = $this->processo->groupValue();
            ...
            $this->indicador->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");

            // periodicidade
            $this->periodicidade->ViewValue = $this->periodicidade->CurrentValue;
            $this->periodicidade->CssClass = "fw-bold";
            $this->periodicidade->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");

            // unidade
            $this->unidade->ViewValue = $this->unidade->CurrentValue;
            $this->unidade->CssClass = "fw-bold";
            $this->unidade->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
            $this->unidade->CellCssStyle .= "text-align: left;";

            // meta
            $this->meta->ViewValue = $this->meta->CurrentValue;
            $this->meta->ViewValue = FormatNumber($this->meta->ViewValue, $this->meta->formatPattern());
            $this->meta->CssClass = "fw-bold";
            $this->meta->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "");
        ...
        if ($this->RowType == RowType::TOTAL) {
            ...
            // indicador
            $currentValue = $this->indicador->CurrentValue;
            $viewValue = &$this->indicador->ViewValue;
            $viewAttrs = &$this->indicador->ViewAttrs;
            $cellAttrs = &$this->indicador->CellAttrs;
            $hrefValue = &$this->indicador->HrefValue;
            $linkAttrs = &$this->indicador->LinkAttrs;
            $this->cellRendered($this->indicador, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // periodicidade
            $currentValue = $this->periodicidade->CurrentValue;
            $viewValue = &$this->periodicidade->ViewValue;
            $viewAttrs = &$this->periodicidade->ViewAttrs;
            $cellAttrs = &$this->periodicidade->CellAttrs;
            $hrefValue = &$this->periodicidade->HrefValue;
            $linkAttrs = &$this->periodicidade->LinkAttrs;
            $this->cellRendered($this->periodicidade, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // unidade
            $currentValue = $this->unidade->CurrentValue;
            $viewValue = &$this->unidade->ViewValue;
            $viewAttrs = &$this->unidade->ViewAttrs;
            $cellAttrs = &$this->unidade->CellAttrs;
            $hrefValue = &$this->unidade->HrefValue;
            $linkAttrs = &$this->unidade->LinkAttrs;
            $this->cellRendered($this->unidade, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);

            // meta
            $currentValue = $this->meta->CurrentValue;
            $viewValue = &$this->meta->ViewValue;
            $viewAttrs = &$this->meta->ViewAttrs;
            $cellAttrs = &$this->meta->CellAttrs;
            $hrefValue = &$this->meta->HrefValue;
            $linkAttrs = &$this->meta->LinkAttrs;
            $this->cellRendered($this->meta, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        }
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->periodicidade->Visible) {
            $this->DetailColumnCount += 1;
        }
        if ($this->unidade->Visible) {
            $this->DetailColumnCount += 1;
        }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"frel_processo_indicadorsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = false;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"frel_processo_indicadorsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = false;
