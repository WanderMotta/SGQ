 ...
 * Page class
 */
class ProcessoIndicadoresDelete extends ProcessoIndicadores
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProcessoIndicadoresDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ProcessoIndicadoresDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ProcessoIndicadoresList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ProcessoIndicadoresList"); // Return to list
                return;
            }
        }
