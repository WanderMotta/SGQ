 ...
 * Page class
 */
class RelatorioAudIntList extends RelatorioAudInt
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RelatorioAudIntList";
    ...
    public $FormName = "frelatorio_aud_intlist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "RelatorioAudIntList";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "RelatorioAudIntAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "RelatorioAudIntDelete";
        $this->MultiUpdateUrl = "RelatorioAudIntUpdate";
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "frelatorio_aud_intgrid";
        }
        ...
        // Load master record
        if ($this->CurrentMode != "add" && $this->DbMasterFilter != "" && $this->getCurrentMasterTable() == "item_plano_aud_int") {
            $masterTbl = Container("item_plano_aud_int");
            $rsmaster = $masterTbl->loadRs($this->DbMasterFilter)->fetchAssociative();
            $this->MasterRecordExists = $rsmaster !== false;
            if (!$this->MasterRecordExists) {
                $this->setFailureMessage($Language->phrase("NoRecord")); // Set no record found
                $this->terminate("ItemPlanoAudIntList"); // Return to master page
                return;
            } else {
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->idrelatorio_aud_int->AdvancedSearch->toJson(), ","); // Field idrelatorio_aud_int
        ...
        $filterList = Concat($filterList, $this->item_plano_aud_int_iditem_plano_aud_int->AdvancedSearch->toJson(), ","); // Field item_plano_aud_int_iditem_plano_aud_int
        ...
        $filterList = Concat($filterList, $this->nao_conformidade->AdvancedSearch->toJson(), ","); // Field nao_conformidade
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("frelatorio_aud_intsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field idrelatorio_aud_int
        $this->idrelatorio_aud_int->AdvancedSearch->SearchValue = @$filter["x_idrelatorio_aud_int"];
        $this->idrelatorio_aud_int->AdvancedSearch->SearchOperator = @$filter["z_idrelatorio_aud_int"];
        $this->idrelatorio_aud_int->AdvancedSearch->SearchCondition = @$filter["v_idrelatorio_aud_int"];
        $this->idrelatorio_aud_int->AdvancedSearch->SearchValue2 = @$filter["y_idrelatorio_aud_int"];
        $this->idrelatorio_aud_int->AdvancedSearch->SearchOperator2 = @$filter["w_idrelatorio_aud_int"];
        $this->idrelatorio_aud_int->AdvancedSearch->save();
        ...
        // Field item_plano_aud_int_iditem_plano_aud_int
        $this->item_plano_aud_int_iditem_plano_aud_int->AdvancedSearch->SearchValue = @$filter["x_item_plano_aud_int_iditem_plano_aud_int"];
        $this->item_plano_aud_int_iditem_plano_aud_int->AdvancedSearch->SearchOperator = @$filter["z_item_plano_aud_int_iditem_plano_aud_int"];
        $this->item_plano_aud_int_iditem_plano_aud_int->AdvancedSearch->SearchCondition = @$filter["v_item_plano_aud_int_iditem_plano_aud_int"];
        $this->item_plano_aud_int_iditem_plano_aud_int->AdvancedSearch->SearchValue2 = @$filter["y_item_plano_aud_int_iditem_plano_aud_int"];
        $this->item_plano_aud_int_iditem_plano_aud_int->AdvancedSearch->SearchOperator2 = @$filter["w_item_plano_aud_int_iditem_plano_aud_int"];
        $this->item_plano_aud_int_iditem_plano_aud_int->AdvancedSearch->save();

        // Field metodo
        $this->metodo->AdvancedSearch->SearchValue = @$filter["x_metodo"];
        $this->metodo->AdvancedSearch->SearchOperator = @$filter["z_metodo"];
        $this->metodo->AdvancedSearch->SearchCondition = @$filter["v_metodo"];
        $this->metodo->AdvancedSearch->SearchValue2 = @$filter["y_metodo"];
        $this->metodo->AdvancedSearch->SearchOperator2 = @$filter["w_metodo"];
        $this->metodo->AdvancedSearch->save();
        ...
        // Field nao_conformidade
        $this->nao_conformidade->AdvancedSearch->SearchValue = @$filter["x_nao_conformidade"];
        $this->nao_conformidade->AdvancedSearch->SearchOperator = @$filter["z_nao_conformidade"];
        $this->nao_conformidade->AdvancedSearch->SearchCondition = @$filter["v_nao_conformidade"];
        $this->nao_conformidade->AdvancedSearch->SearchValue2 = @$filter["y_nao_conformidade"];
        $this->nao_conformidade->AdvancedSearch->SearchOperator2 = @$filter["w_nao_conformidade"];
        $this->nao_conformidade->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if ($this->Command != "json") {
            $defaultSort = $this->plano_auditoria_int_idplano_auditoria_int->Expression . " DESC" . ", " . $this->item_plano_aud_int_iditem_plano_aud_int->Expression . " ASC"; // Set up default sort
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->plano_auditoria_int_idplano_auditoria_int, $ctrl); // plano_auditoria_int_idplano_auditoria_int
            $this->updateSort($this->item_plano_aud_int_iditem_plano_aud_int, $ctrl); // item_plano_aud_int_iditem_plano_aud_int
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->idrelatorio_aud_int->setSort("");
                $this->dt_cadastro->setSort("");
                $this->plano_auditoria_int_idplano_auditoria_int->setSort("");
                $this->item_plano_aud_int_iditem_plano_aud_int->setSort("");
                $this->metodo->setSort("");
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"relatorio_aud_int\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"relatorio_aud_int\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
            ...
            if ($Security->canAdd()) {
                if ($this->ModalAdd && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-copy\" title=\"" . $copycaption . "\" data-table=\"relatorio_aud_int\" data-caption=\"" . $copycaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->CopyUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("CopyLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"frelatorio_aud_intlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"frelatorio_aud_intlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->idrelatorio_aud_int->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"relatorio_aud_int\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "plano_auditoria_int_idplano_auditoria_int");
            $this->createColumnOption($option, "item_plano_aud_int_iditem_plano_aud_int");
            $this->createColumnOption($option, "metodo");
            $this->createColumnOption($option, "descricao");
            $this->createColumnOption($option, "evidencia");
            $this->createColumnOption($option, "nao_conformidade");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"frelatorio_aud_intsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"frelatorio_aud_intsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="frelatorio_aud_intlist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_relatorio_aud_int", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_relatorio_aud_int",
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->nao_conformidade->TooltipValue = "";
                ...
                $this->descricao->Count = 0; // Initialize count
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="frelatorio_aud_intlist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"frelatorio_aud_intsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    */
    public function exportData($doc)
    {
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->DbMasterFilter != "" && $this->getCurrentMasterTable() == "item_plano_aud_int") {
            $item_plano_aud_int = new ItemPlanoAudIntList();
            $rsmaster = $item_plano_aud_int->loadRs($this->DbMasterFilter); // Load master record
            if ($rsmaster) {
                $exportStyle = $doc->Style;
                $doc->setStyle("v"); // Change to vertical
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    $doc->setTable($item_plano_aud_int);
                    $item_plano_aud_int->exportDocument($doc, $rsmaster);
                    $doc->exportEmptyRow();
                    $doc->setTable($this);
                }
