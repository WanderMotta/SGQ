 ...
 * Page class
 */
class PlanoAcaoNcGrid extends PlanoAcaoNc
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanoAcaoNcGrid";
    ...
    public $FormName = "fplano_acao_ncgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "PlanoAcaoNcGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->idplano_acao_nc->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->idplano_acao_nc->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "nao_conformidade") {
            $this->nao_conformidade_idnao_conformidade->Visible = true; // Need to insert foreign key
            $this->nao_conformidade_idnao_conformidade->CurrentValue = $this->nao_conformidade_idnao_conformidade->getSessionValue();
        }
        ...
        // Check referential integrity for master table 'plano_acao_nc'
        $validMasterRecord = true;
        $detailKeys = [];
        $detailKeys["nao_conformidade_idnao_conformidade"] = $this->nao_conformidade_idnao_conformidade->getSessionValue();
        $masterTable = Container("nao_conformidade");
        $masterFilter = $this->getMasterFilter($masterTable, $detailKeys);
        if (!EmptyValue($masterFilter)) {
            $rsmaster = $masterTable->loadRs($masterFilter)->fetch();
    ...
    protected function getAddRow()
    {
        ...
        if ($this->nao_conformidade_idnao_conformidade->getSessionValue() != "") {
            $rsnew['nao_conformidade_idnao_conformidade'] = $this->nao_conformidade_idnao_conformidade->getSessionValue();
        }
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['nao_conformidade_idnao_conformidade'])) { // nao_conformidade_idnao_conformidade
            $this->nao_conformidade_idnao_conformidade->setFormValue($row['nao_conformidade_idnao_conformidade']);
        }
    }
