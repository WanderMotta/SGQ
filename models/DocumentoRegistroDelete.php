 ...
 * Page class
 */
class DocumentoRegistroDelete extends DocumentoRegistro
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentoRegistroDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentoRegistroDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DocumentoRegistroList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DocumentoRegistroList"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['iddocumento_registro'];
