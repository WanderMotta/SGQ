...
/**
 * Table class for relatorio_aud_int
 */
class RelatorioAudInt extends DbTable
{
    protected $SqlFrom = "";
    ...
    // Fields
    public $idrelatorio_aud_int;
    public $dt_cadastro;
    public $plano_auditoria_int_idplano_auditoria_int;
    public $item_plano_aud_int_iditem_plano_aud_int;
    public $metodo;
    public $descricao;
    public $evidencia;
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "relatorio_aud_int";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // idrelatorio_aud_int
        $this->idrelatorio_aud_int = new DbField(
            $this, // Table
            'x_idrelatorio_aud_int', // Variable name
            'idrelatorio_aud_int', // Name
            '`idrelatorio_aud_int`', // Expression
            '`idrelatorio_aud_int`', // Basic search expression
            19, // Type
            3, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`idrelatorio_aud_int`', // Virtual expression
            false, // Is virtual
        ...
        $this->idrelatorio_aud_int->InputTextType = "text";
        $this->idrelatorio_aud_int->Raw = true;
        $this->idrelatorio_aud_int->IsAutoIncrement = true; // Autoincrement field
        $this->idrelatorio_aud_int->IsPrimaryKey = true; // Primary key field
        $this->idrelatorio_aud_int->Nullable = false; // NOT NULL field
        $this->idrelatorio_aud_int->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->idrelatorio_aud_int->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['idrelatorio_aud_int'] = &$this->idrelatorio_aud_int;
        ...
        $this->plano_auditoria_int_idplano_auditoria_int = new DbField(
            $this, // Table
            'x_plano_auditoria_int_idplano_auditoria_int', // Variable name
            'plano_auditoria_int_idplano_auditoria_int', // Name
            '`plano_auditoria_int_idplano_auditoria_int`', // Expression
            '`plano_auditoria_int_idplano_auditoria_int`', // Basic search expression
            19, // Type
            3, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`plano_auditoria_int_idplano_auditoria_int`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->plano_auditoria_int_idplano_auditoria_int->InputTextType = "text";
        $this->plano_auditoria_int_idplano_auditoria_int->Raw = true;
        $this->plano_auditoria_int_idplano_auditoria_int->Nullable = false; // NOT NULL field
        $this->plano_auditoria_int_idplano_auditoria_int->Required = true; // Required field
        $this->plano_auditoria_int_idplano_auditoria_int->setSelectMultiple(false); // Select one
        $this->plano_auditoria_int_idplano_auditoria_int->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->plano_auditoria_int_idplano_auditoria_int->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->plano_auditoria_int_idplano_auditoria_int->Lookup = new Lookup($this->plano_auditoria_int_idplano_auditoria_int, 'plano_auditoria_int', false, 'idplano_auditoria_int', ["idplano_auditoria_int","data","",""], '', '', [], ["x_item_plano_aud_int_iditem_plano_aud_int"], [], [], [], [], false, '`idplano_auditoria_int` DESC', '', "CONCAT(COALESCE(`idplano_auditoria_int`, ''),'" . ValueSeparator(1, $this->plano_auditoria_int_idplano_auditoria_int) . "',COALESCE(" . CastDateFieldForLike("`data`", 0, "DB") . ",''))");
        $this->plano_auditoria_int_idplano_auditoria_int->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->plano_auditoria_int_idplano_auditoria_int->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['plano_auditoria_int_idplano_auditoria_int'] = &$this->plano_auditoria_int_idplano_auditoria_int;

        // item_plano_aud_int_iditem_plano_aud_int
        $this->item_plano_aud_int_iditem_plano_aud_int = new DbField(
            $this, // Table
            'x_item_plano_aud_int_iditem_plano_aud_int', // Variable name
            'item_plano_aud_int_iditem_plano_aud_int', // Name
            '`item_plano_aud_int_iditem_plano_aud_int`', // Expression
            '`item_plano_aud_int_iditem_plano_aud_int`', // Basic search expression
            19, // Type
            3, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`item_plano_aud_int_iditem_plano_aud_int`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->item_plano_aud_int_iditem_plano_aud_int->InputTextType = "text";
        $this->item_plano_aud_int_iditem_plano_aud_int->Raw = true;
        $this->item_plano_aud_int_iditem_plano_aud_int->IsForeignKey = true; // Foreign key field
        $this->item_plano_aud_int_iditem_plano_aud_int->Nullable = false; // NOT NULL field
        $this->item_plano_aud_int_iditem_plano_aud_int->Required = true; // Required field
        $this->item_plano_aud_int_iditem_plano_aud_int->Lookup = new Lookup($this->item_plano_aud_int_iditem_plano_aud_int, 'item_plano_aud_int', false, 'iditem_plano_aud_int', ["processo_idprocesso","","",""], '', '', ["x_plano_auditoria_int_idplano_auditoria_int"], [], ["plano_auditoria_int_idplano_auditoria_int"], ["x_plano_auditoria_int_idplano_auditoria_int"], [], [], false, '`iditem_plano_aud_int` DESC', '', "`processo_idprocesso`");
        $this->item_plano_aud_int_iditem_plano_aud_int->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->item_plano_aud_int_iditem_plano_aud_int->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['item_plano_aud_int_iditem_plano_aud_int'] = &$this->item_plano_aud_int_iditem_plano_aud_int;
        ...
        $this->metodo->Lookup = new Lookup($this->metodo, 'relatorio_aud_int', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->nao_conformidade->Lookup = new Lookup($this->nao_conformidade, 'relatorio_aud_int', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function getMasterFilterFromSession()
    {
        // Master filter
        $masterFilter = "";
        if ($this->getCurrentMasterTable() == "item_plano_aud_int") {
            $masterTable = Container("item_plano_aud_int");
            if ($this->item_plano_aud_int_iditem_plano_aud_int->getSessionValue() != "") {
                $masterFilter .= "" . GetKeyFilter($masterTable->iditem_plano_aud_int, $this->item_plano_aud_int_iditem_plano_aud_int->getSessionValue(), $masterTable->iditem_plano_aud_int->DataType, $masterTable->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "item_plano_aud_int") {
            $masterTable = Container("item_plano_aud_int");
            if ($this->item_plano_aud_int_iditem_plano_aud_int->getSessionValue() != "") {
                $detailFilter .= "" . GetKeyFilter($this->item_plano_aud_int_iditem_plano_aud_int, $this->item_plano_aud_int_iditem_plano_aud_int->getSessionValue(), $masterTable->iditem_plano_aud_int->DataType, $this->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "item_plano_aud_int":
                $key = $keys["item_plano_aud_int_iditem_plano_aud_int"] ?? "";
                if (EmptyValue($key)) {
                    if ($masterTable->iditem_plano_aud_int->Required) { // Required field and empty value
                ...
                if ($validKeys) {
                    return GetKeyFilter($masterTable->iditem_plano_aud_int, $keys["item_plano_aud_int_iditem_plano_aud_int"], $this->item_plano_aud_int_iditem_plano_aud_int->DataType, $this->Dbid);
                }
                break;
        }
    ...
    public function getDetailFilter($masterTable)
    {
        switch ($masterTable->TableVar) {
            case "item_plano_aud_int":
                return GetKeyFilter($this->item_plano_aud_int_iditem_plano_aud_int, $masterTable->iditem_plano_aud_int->DbValue, $masterTable->iditem_plano_aud_int->DataType, $masterTable->Dbid);
        }
        return "";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "relatorio_aud_int";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($result) {
            $this->idrelatorio_aud_int->setDbValue($conn->lastInsertId());
            $rs['idrelatorio_aud_int'] = $this->idrelatorio_aud_int->DbValue;
        }
        return $result;
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['idrelatorio_aud_int']) && !EmptyValue($this->idrelatorio_aud_int->CurrentValue)) {
                $rs['idrelatorio_aud_int'] = $this->idrelatorio_aud_int->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('idrelatorio_aud_int', $rs)) {
                AddFilter($where, QuotedName('idrelatorio_aud_int', $this->Dbid) . '=' . QuotedValue($rs['idrelatorio_aud_int'], $this->idrelatorio_aud_int->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->idrelatorio_aud_int->DbValue = $row['idrelatorio_aud_int'];
        $this->dt_cadastro->DbValue = $row['dt_cadastro'];
        $this->plano_auditoria_int_idplano_auditoria_int->DbValue = $row['plano_auditoria_int_idplano_auditoria_int'];
        $this->item_plano_aud_int_iditem_plano_aud_int->DbValue = $row['item_plano_aud_int_iditem_plano_aud_int'];
    ...
    {
        return "`idrelatorio_aud_int` = @idrelatorio_aud_int@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->idrelatorio_aud_int->CurrentValue : $this->idrelatorio_aud_int->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->idrelatorio_aud_int->CurrentValue = $keys[0];
            } else {
                $this->idrelatorio_aud_int->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('idrelatorio_aud_int', $row) ? $row['idrelatorio_aud_int'] : null;
        } else {
            $val = !EmptyValue($this->idrelatorio_aud_int->OldValue) && !$current ? $this->idrelatorio_aud_int->OldValue : $this->idrelatorio_aud_int->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@idrelatorio_aud_int@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("RelatorioAudIntList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "RelatorioAudIntView" => $Language->phrase("View"),
            "RelatorioAudIntEdit" => $Language->phrase("Edit"),
            "RelatorioAudIntAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "RelatorioAudIntView",
            Config("API_ADD_ACTION") => "RelatorioAudIntAdd",
            Config("API_EDIT_ACTION") => "RelatorioAudIntEdit",
            Config("API_DELETE_ACTION") => "RelatorioAudIntDelete",
            Config("API_LIST_ACTION") => "RelatorioAudIntList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("RelatorioAudIntView", $parm);
        } else {
            $url = $this->keyUrl("RelatorioAudIntView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "RelatorioAudIntAdd?" . $parm;
        } else {
            $url = "RelatorioAudIntAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RelatorioAudIntEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RelatorioAudIntList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RelatorioAudIntAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RelatorioAudIntList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("RelatorioAudIntDelete", $parm);
        }
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "item_plano_aud_int" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_iditem_plano_aud_int", $this->item_plano_aud_int_iditem_plano_aud_int->getSessionValue()); // Use Session Value
        }
        return $url;
    }
    ...
    {
        $json = "";
        $json .= "\"idrelatorio_aud_int\":" . VarToJson($this->idrelatorio_aud_int->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->idrelatorio_aud_int->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->idrelatorio_aud_int->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("idrelatorio_aud_int") ?? Route("idrelatorio_aud_int")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->idrelatorio_aud_int->CurrentValue = $key;
            } else {
                $this->idrelatorio_aud_int->OldValue = $key;
            }
    ...
    public function renderListRow()
    {
        ...
        $this->idrelatorio_aud_int->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // plano_auditoria_int_idplano_auditoria_int
        $this->plano_auditoria_int_idplano_auditoria_int->setupEditAttributes();
    ...
    public function exportDocument($doc, $result, $startRec = 1, $stopRec = 1, $exportPageType = "")
    {
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->idrelatorio_aud_int);
                    $doc->exportCaption($this->dt_cadastro);
                    $doc->exportCaption($this->plano_auditoria_int_idplano_auditoria_int);
                    $doc->exportCaption($this->item_plano_aud_int_iditem_plano_aud_int);
        ...
        while (($row = $result->fetch()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->idrelatorio_aud_int);
                        $doc->exportField($this->dt_cadastro);
                        $doc->exportField($this->plano_auditoria_int_idplano_auditoria_int);
                        $doc->exportField($this->item_plano_aud_int_iditem_plano_aud_int);
        ...
        if ($doc->Horizontal) {
            ...
            if (!$doc->ExportCustom) {
                ...
                $doc->exportAggregate($this->plano_auditoria_int_idplano_auditoria_int, '');
                $doc->exportAggregate($this->item_plano_aud_int_iditem_plano_aud_int, '');
                $doc->exportAggregate($this->metodo, '');
                $doc->exportAggregate($this->descricao, 'COUNT');
                $doc->exportAggregate($this->evidencia, '');
                $doc->exportAggregate($this->nao_conformidade, '');
                $doc->endExportRow();
            }
        }
        if (!$doc->ExportCustom) {
