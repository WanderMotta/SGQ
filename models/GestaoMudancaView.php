 ...
 * Page class
 */
class GestaoMudancaView extends GestaoMudanca
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GestaoMudancaView";
    ...
    // CSS class/style
    public $CurrentPageName = "GestaoMudancaView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idgestao_mudanca") ?? Route("idgestao_mudanca")) !== null) {
            $this->RecKey["idgestao_mudanca"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idgestao_mudanca") ?? Route("idgestao_mudanca")) !== null) {
            ...
            $this->RecKey["idgestao_mudanca"] = $this->idgestao_mudanca->QueryStringValue;
        } elseif (Post("idgestao_mudanca") !== null) {
            $this->idgestao_mudanca->setFormValue(Post("idgestao_mudanca"));
            $this->RecKey["idgestao_mudanca"] = $this->idgestao_mudanca->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idgestao_mudanca->setQueryStringValue($keyValue);
            $this->RecKey["idgestao_mudanca"] = $this->idgestao_mudanca->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "GestaoMudancaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("GestaoMudancaList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idgestao_mudanca->CurrentValue, $this->CurrentRow['idgestao_mudanca'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "GestaoMudancaList"; // No matching record, return to list
                    } else {
