 ...
 * Page class
 */
class ItemRelAudInternaPreview extends ItemRelAudInterna
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemRelAudInternaPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ItemRelAudInternaPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "relatorio_auditoria_interna") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=relatorio_auditoria_interna&" . GetForeignKeyUrl("fk_idrelatorio_auditoria_interna", $this->relatorio_auditoria_interna_idrelatorio_auditoria_interna->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "relatorio_auditoria_interna") {
            $this->relatorio_auditoria_interna_idrelatorio_auditoria_interna->setQueryStringValue($keys[0] ?? "");
        }
    }
