 ...
 * Page class
 */
class ImpactoDelete extends Impacto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ImpactoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ImpactoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ImpactoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ImpactoList"); // Return to list
                return;
            }
        }
