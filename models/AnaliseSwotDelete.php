 ...
 * Page class
 */
class AnaliseSwotDelete extends AnaliseSwot
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AnaliseSwotDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AnaliseSwotDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AnaliseSwotList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("AnaliseSwotList"); // Return to list
                return;
            }
        }
