 ...
 * Page class
 */
class PlanoAcaoNcView extends PlanoAcaoNc
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanoAcaoNcView";
    ...
    // CSS class/style
    public $CurrentPageName = "PlanoAcaoNcView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idplano_acao_nc") ?? Route("idplano_acao_nc")) !== null) {
            $this->RecKey["idplano_acao_nc"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idplano_acao_nc") ?? Route("idplano_acao_nc")) !== null) {
            ...
            $this->RecKey["idplano_acao_nc"] = $this->idplano_acao_nc->QueryStringValue;
        } elseif (Post("idplano_acao_nc") !== null) {
            $this->idplano_acao_nc->setFormValue(Post("idplano_acao_nc"));
            $this->RecKey["idplano_acao_nc"] = $this->idplano_acao_nc->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idplano_acao_nc->setQueryStringValue($keyValue);
            $this->RecKey["idplano_acao_nc"] = $this->idplano_acao_nc->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "PlanoAcaoNcList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("PlanoAcaoNcList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idplano_acao_nc->CurrentValue, $this->CurrentRow['idplano_acao_nc'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "PlanoAcaoNcList"; // No matching record, return to list
                    } else {
