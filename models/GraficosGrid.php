 ...
 * Page class
 */
class GraficosGrid extends Graficos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GraficosGrid";
    ...
    public $FormName = "fgraficosgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "GraficosGrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "indicadores") {
            $this->indicadores_idindicadores->Visible = true; // Need to insert foreign key
            $this->indicadores_idindicadores->CurrentValue = $this->indicadores_idindicadores->getSessionValue();
        }
    ...
    protected function setupMasterParms()
    {
        ...
        if ($masterTblVar == "indicadores") {
            $masterTbl = Container("indicadores");
            $this->indicadores_idindicadores->Visible = false;
