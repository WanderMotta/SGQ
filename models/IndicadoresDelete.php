 ...
 * Page class
 */
class IndicadoresDelete extends Indicadores
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IndicadoresDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "IndicadoresDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("IndicadoresList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("IndicadoresList"); // Return to list
                return;
            }
        }
