...
/**
 * Table class for plano_acao_nc
 */
class PlanoAcaoNc extends DbTable
{
    protected $SqlFrom = "";
    ...
    // Fields
    public $idplano_acao_nc;
    public $dt_cadastro;
    public $nao_conformidade_idnao_conformidade;
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "plano_acao_nc";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // idplano_acao_nc
        $this->idplano_acao_nc = new DbField(
            $this, // Table
            'x_idplano_acao_nc', // Variable name
            'idplano_acao_nc', // Name
            '`idplano_acao_nc`', // Expression
            '`idplano_acao_nc`', // Basic search expression
            19, // Type
            4, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`idplano_acao_nc`', // Virtual expression
            false, // Is virtual
        ...
        $this->idplano_acao_nc->InputTextType = "text";
        $this->idplano_acao_nc->Raw = true;
        $this->idplano_acao_nc->IsAutoIncrement = true; // Autoincrement field
        $this->idplano_acao_nc->IsPrimaryKey = true; // Primary key field
        $this->idplano_acao_nc->Nullable = false; // NOT NULL field
        $this->idplano_acao_nc->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->idplano_acao_nc->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['idplano_acao_nc'] = &$this->idplano_acao_nc;
        ...
        $this->nao_conformidade_idnao_conformidade = new DbField(
            $this, // Table
            'x_nao_conformidade_idnao_conformidade', // Variable name
            'nao_conformidade_idnao_conformidade', // Name
            '`nao_conformidade_idnao_conformidade`', // Expression
            '`nao_conformidade_idnao_conformidade`', // Basic search expression
            19, // Type
            3, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`nao_conformidade_idnao_conformidade`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->nao_conformidade_idnao_conformidade->InputTextType = "text";
        $this->nao_conformidade_idnao_conformidade->Raw = true;
        $this->nao_conformidade_idnao_conformidade->IsForeignKey = true; // Foreign key field
        $this->nao_conformidade_idnao_conformidade->Nullable = false; // NOT NULL field
        $this->nao_conformidade_idnao_conformidade->Required = true; // Required field
        $this->nao_conformidade_idnao_conformidade->setSelectMultiple(false); // Select one
        $this->nao_conformidade_idnao_conformidade->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->nao_conformidade_idnao_conformidade->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->nao_conformidade_idnao_conformidade->Lookup = new Lookup($this->nao_conformidade_idnao_conformidade, 'nao_conformidade', false, 'idnao_conformidade', ["titulo","","",""], '', '', [], [], [], [], [], [], false, '`titulo` ASC', '', "`titulo`");
        $this->nao_conformidade_idnao_conformidade->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->nao_conformidade_idnao_conformidade->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['nao_conformidade_idnao_conformidade'] = &$this->nao_conformidade_idnao_conformidade;
        ...
        $this->implementado->Lookup = new Lookup($this->implementado, 'plano_acao_nc', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->eficaz->Lookup = new Lookup($this->eficaz, 'plano_acao_nc', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->evidencia->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    public function getMasterFilterFromSession()
    {
        // Master filter
        $masterFilter = "";
        if ($this->getCurrentMasterTable() == "nao_conformidade") {
            $masterTable = Container("nao_conformidade");
            if ($this->nao_conformidade_idnao_conformidade->getSessionValue() != "") {
                $masterFilter .= "" . GetKeyFilter($masterTable->idnao_conformidade, $this->nao_conformidade_idnao_conformidade->getSessionValue(), $masterTable->idnao_conformidade->DataType, $masterTable->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getDetailFilterFromSession()
    {
        ...
        if ($this->getCurrentMasterTable() == "nao_conformidade") {
            $masterTable = Container("nao_conformidade");
            if ($this->nao_conformidade_idnao_conformidade->getSessionValue() != "") {
                $detailFilter .= "" . GetKeyFilter($this->nao_conformidade_idnao_conformidade, $this->nao_conformidade_idnao_conformidade->getSessionValue(), $masterTable->idnao_conformidade->DataType, $this->Dbid);
            } else {
                return "";
            }
        }
    ...
    public function getMasterFilter($masterTable, $keys)
    {
        ...
        switch ($masterTable->TableVar) {
            case "nao_conformidade":
                $key = $keys["nao_conformidade_idnao_conformidade"] ?? "";
                if (EmptyValue($key)) {
                    if ($masterTable->idnao_conformidade->Required) { // Required field and empty value
                ...
                if ($validKeys) {
                    return GetKeyFilter($masterTable->idnao_conformidade, $keys["nao_conformidade_idnao_conformidade"], $this->nao_conformidade_idnao_conformidade->DataType, $this->Dbid);
                }
                break;
        }
    ...
    public function getDetailFilter($masterTable)
    {
        switch ($masterTable->TableVar) {
            case "nao_conformidade":
                return GetKeyFilter($this->nao_conformidade_idnao_conformidade, $masterTable->idnao_conformidade->DbValue, $masterTable->idnao_conformidade->DataType, $masterTable->Dbid);
        }
        return "";
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "plano_acao_nc";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($result) {
            $this->idplano_acao_nc->setDbValue($conn->lastInsertId());
            $rs['idplano_acao_nc'] = $this->idplano_acao_nc->DbValue;
        }
        return $result;
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['idplano_acao_nc']) && !EmptyValue($this->idplano_acao_nc->CurrentValue)) {
                $rs['idplano_acao_nc'] = $this->idplano_acao_nc->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('idplano_acao_nc', $rs)) {
                AddFilter($where, QuotedName('idplano_acao_nc', $this->Dbid) . '=' . QuotedValue($rs['idplano_acao_nc'], $this->idplano_acao_nc->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->idplano_acao_nc->DbValue = $row['idplano_acao_nc'];
        $this->dt_cadastro->DbValue = $row['dt_cadastro'];
        $this->nao_conformidade_idnao_conformidade->DbValue = $row['nao_conformidade_idnao_conformidade'];
    ...
    {
        return "`idplano_acao_nc` = @idplano_acao_nc@";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->idplano_acao_nc->CurrentValue : $this->idplano_acao_nc->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->idplano_acao_nc->CurrentValue = $keys[0];
            } else {
                $this->idplano_acao_nc->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('idplano_acao_nc', $row) ? $row['idplano_acao_nc'] : null;
        } else {
            $val = !EmptyValue($this->idplano_acao_nc->OldValue) && !$current ? $this->idplano_acao_nc->OldValue : $this->idplano_acao_nc->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@idplano_acao_nc@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PlanoAcaoNcList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "PlanoAcaoNcView" => $Language->phrase("View"),
            "PlanoAcaoNcEdit" => $Language->phrase("Edit"),
            "PlanoAcaoNcAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "PlanoAcaoNcView",
            Config("API_ADD_ACTION") => "PlanoAcaoNcAdd",
            Config("API_EDIT_ACTION") => "PlanoAcaoNcEdit",
            Config("API_DELETE_ACTION") => "PlanoAcaoNcDelete",
            Config("API_LIST_ACTION") => "PlanoAcaoNcList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PlanoAcaoNcView", $parm);
        } else {
            $url = $this->keyUrl("PlanoAcaoNcView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PlanoAcaoNcEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PlanoAcaoNcList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PlanoAcaoNcAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PlanoAcaoNcList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("PlanoAcaoNcDelete", $parm);
        }
    }
    ...
    {
        if ($this->getCurrentMasterTable() == "nao_conformidade" && !ContainsString($url, Config("TABLE_SHOW_MASTER") . "=")) {
            $url .= (ContainsString($url, "?") ? "&" : "?") . Config("TABLE_SHOW_MASTER") . "=" . $this->getCurrentMasterTable();
            $url .= "&" . GetForeignKeyUrl("fk_idnao_conformidade", $this->nao_conformidade_idnao_conformidade->getSessionValue()); // Use Session Value
        }
        return $url;
    }
    ...
    {
        $json = "";
        $json .= "\"idplano_acao_nc\":" . VarToJson($this->idplano_acao_nc->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->idplano_acao_nc->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->idplano_acao_nc->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("idplano_acao_nc") ?? Route("idplano_acao_nc")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->idplano_acao_nc->CurrentValue = $key;
            } else {
                $this->idplano_acao_nc->OldValue = $key;
            }
    ...
    public function exportDocument($doc, $result, $startRec = 1, $stopRec = 1, $exportPageType = "")
    {
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->idplano_acao_nc);
                    $doc->exportCaption($this->dt_cadastro);
                    $doc->exportCaption($this->nao_conformidade_idnao_conformidade);
        ...
        while (($row = $result->fetch()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->idplano_acao_nc);
                        $doc->exportField($this->dt_cadastro);
                        $doc->exportField($this->nao_conformidade_idnao_conformidade);
        ...
        if ($doc->Horizontal) {
            ...
            if (!$doc->ExportCustom) {
                ...
                $doc->exportAggregate($this->idplano_acao_nc, '');
                $doc->exportAggregate($this->dt_cadastro, '');
                $doc->exportAggregate($this->nao_conformidade_idnao_conformidade, '');
