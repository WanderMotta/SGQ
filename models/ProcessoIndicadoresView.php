 ...
 * Page class
 */
class ProcessoIndicadoresView extends ProcessoIndicadores
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProcessoIndicadoresView";
    ...
    // CSS class/style
    public $CurrentPageName = "ProcessoIndicadoresView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idprocesso_indicadores") ?? Route("idprocesso_indicadores")) !== null) {
            $this->RecKey["idprocesso_indicadores"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idprocesso_indicadores") ?? Route("idprocesso_indicadores")) !== null) {
            ...
            $this->RecKey["idprocesso_indicadores"] = $this->idprocesso_indicadores->QueryStringValue;
        } elseif (Post("idprocesso_indicadores") !== null) {
            $this->idprocesso_indicadores->setFormValue(Post("idprocesso_indicadores"));
            $this->RecKey["idprocesso_indicadores"] = $this->idprocesso_indicadores->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idprocesso_indicadores->setQueryStringValue($keyValue);
            $this->RecKey["idprocesso_indicadores"] = $this->idprocesso_indicadores->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ProcessoIndicadoresList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ProcessoIndicadoresList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idprocesso_indicadores->CurrentValue, $this->CurrentRow['idprocesso_indicadores'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ProcessoIndicadoresList"; // No matching record, return to list
                    } else {
