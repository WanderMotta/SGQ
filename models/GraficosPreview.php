 ...
 * Page class
 */
class GraficosPreview extends Graficos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GraficosPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "GraficosPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "indicadores") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=indicadores&" . GetForeignKeyUrl("fk_idindicadores", $this->indicadores_idindicadores->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "indicadores") {
            $this->indicadores_idindicadores->setQueryStringValue($keys[0] ?? "");
        }
    }
