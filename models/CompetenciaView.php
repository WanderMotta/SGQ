 ...
 * Page class
 */
class CompetenciaView extends Competencia
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CompetenciaView";
    ...
    // CSS class/style
    public $CurrentPageName = "CompetenciaView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idcompetencia") ?? Route("idcompetencia")) !== null) {
            $this->RecKey["idcompetencia"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idcompetencia") ?? Route("idcompetencia")) !== null) {
            ...
            $this->RecKey["idcompetencia"] = $this->idcompetencia->QueryStringValue;
        } elseif (Post("idcompetencia") !== null) {
            $this->idcompetencia->setFormValue(Post("idcompetencia"));
            $this->RecKey["idcompetencia"] = $this->idcompetencia->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idcompetencia->setQueryStringValue($keyValue);
            $this->RecKey["idcompetencia"] = $this->idcompetencia->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "CompetenciaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("CompetenciaList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idcompetencia->CurrentValue, $this->CurrentRow['idcompetencia'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "CompetenciaList"; // No matching record, return to list
                    } else {
