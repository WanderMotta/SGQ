 ...
 * Page class
 */
class ObjetivoQualidadeAdd extends ObjetivoQualidade
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ObjetivoQualidadeAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ObjetivoQualidadeAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ObjetivoQualidadeView") {
    ...
    protected function getAddRow()
    {
        ...
        // como_medir
        $this->como_medir->setDbValueDef($rsnew, $this->como_medir->CurrentValue, false);

        // o_q_sera_feito
        $this->o_q_sera_feito->setDbValueDef($rsnew, $this->o_q_sera_feito->CurrentValue, false);

        // como_avaliar
        $this->como_avaliar->setDbValueDef($rsnew, $this->como_avaliar->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['como_medir'])) { // como_medir
            $this->como_medir->setFormValue($row['como_medir']);
        }
        ...
        if (isset($row['como_avaliar'])) { // como_avaliar
            $this->como_avaliar->setFormValue($row['como_avaliar']);
        }
