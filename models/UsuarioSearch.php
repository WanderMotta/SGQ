...
class UsuarioSearch extends Usuario
{
    ...
    // Page object name
    public $PageObjName = "UsuarioSearch";
    ...
    // CSS class/style
    public $CurrentPageName = "UsuarioSearch";
    ...
    {
        $srchUrl = "";
        $this->buildSearchUrl($srchUrl, $this->idusuario); // idusuario
        $this->buildSearchUrl($srchUrl, $this->nome); // nome
        $this->buildSearchUrl($srchUrl, $this->_login); // login
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->idusuario->EditValue = $this->idusuario->AdvancedSearch->SearchValue;
            $this->idusuario->PlaceHolder = RemoveHtml($this->idusuario->caption());
            ...
            if (!$this->_login->Raw) {
                $this->_login->AdvancedSearch->SearchValue = HtmlDecode($this->_login->AdvancedSearch->SearchValue);
            }
            $this->_login->EditValue = HtmlEncode($this->_login->AdvancedSearch->SearchValue);
            ...
            if (!$Security->canAdmin()) { // System admin
                ...
                if ($this->status->AdvancedSearch->ViewValue !== null) { // Load from cache
                    ...
                    if ($curVal == "") {
                        ...
                        $filterWrk = SearchFilter($this->status->Lookup->getTable()->Fields["UserLevelID"]->searchExpression(), "=", $this->status->AdvancedSearch->SearchValue, $this->status->Lookup->getTable()->Fields["UserLevelID"]->searchDataType(), "");
                    }
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->idusuario->AdvancedSearch->SearchValue)) {
            $this->idusuario->addErrorMessage($this->idusuario->getErrorMessage(false));
        }
