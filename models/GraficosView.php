 ...
 * Page class
 */
class GraficosView extends Graficos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "GraficosView";
    ...
    // CSS class/style
    public $CurrentPageName = "GraficosView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idgraficos") ?? Route("idgraficos")) !== null) {
            $this->RecKey["idgraficos"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idgraficos") ?? Route("idgraficos")) !== null) {
            ...
            $this->RecKey["idgraficos"] = $this->idgraficos->QueryStringValue;
        } elseif (Post("idgraficos") !== null) {
            $this->idgraficos->setFormValue(Post("idgraficos"));
            $this->RecKey["idgraficos"] = $this->idgraficos->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idgraficos->setQueryStringValue($keyValue);
            $this->RecKey["idgraficos"] = $this->idgraficos->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "GraficosList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("GraficosList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idgraficos->CurrentValue, $this->CurrentRow['idgraficos'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "GraficosList"; // No matching record, return to list
                    } else {
