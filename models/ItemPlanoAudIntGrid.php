 ...
 * Page class
 */
class ItemPlanoAudIntGrid extends ItemPlanoAudInt
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemPlanoAudIntGrid";
    ...
    public $FormName = "fitem_plano_aud_intgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ItemPlanoAudIntGrid";
    ...
    public function __construct()
    {
        ...
        $this->AddUrl = "ItemPlanoAudIntAdd";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->iditem_plano_aud_int->CurrentValue;
    ...
    public function emptyRow()
    {
        ...
        if (
            $CurrentForm->hasValue("x_processo_idprocesso") &&
            $CurrentForm->hasValue("o_processo_idprocesso") &&
            $this->processo_idprocesso->CurrentValue != $this->processo_idprocesso->DefaultValue &&
            !($this->processo_idprocesso->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->processo_idprocesso->CurrentValue == $this->processo_idprocesso->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_escopo") &&
            $CurrentForm->hasValue("o_escopo") &&
            $this->escopo->CurrentValue != $this->escopo->DefaultValue &&
            !($this->escopo->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->escopo->CurrentValue == $this->escopo->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_usuario_idusuario") &&
            $CurrentForm->hasValue("o_usuario_idusuario") &&
            $this->usuario_idusuario->CurrentValue != $this->usuario_idusuario->DefaultValue &&
            !($this->usuario_idusuario->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->usuario_idusuario->CurrentValue == $this->usuario_idusuario->getSessionValue())
        ) {
            return false;
        }
        return true;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->iditem_plano_aud_int->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->iditem_plano_aud_int->setFormValue($val);
        }
        ...
        if ($CurrentForm->hasValue("o_processo_idprocesso")) {
            $this->processo_idprocesso->setOldValue($CurrentForm->getValue("o_processo_idprocesso"));
        }
        ...
        if ($CurrentForm->hasValue("o_escopo")) {
            $this->escopo->setOldValue($CurrentForm->getValue("o_escopo"));
        }
        ...
        if ($CurrentForm->hasValue("o_usuario_idusuario")) {
            $this->usuario_idusuario->setOldValue($CurrentForm->getValue("o_usuario_idusuario"));
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->iditem_plano_aud_int->CurrentValue = $this->iditem_plano_aud_int->FormValue;
        }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            if ($this->iditem_plano_aud_int->Visible && $this->iditem_plano_aud_int->Required) {
                if (!$this->iditem_plano_aud_int->IsDetailKey && EmptyValue($this->iditem_plano_aud_int->FormValue)) {
                    $this->iditem_plano_aud_int->addErrorMessage(str_replace("%s", $this->iditem_plano_aud_int->caption(), $this->iditem_plano_aud_int->RequiredErrorMessage));
                }
            }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['iditem_plano_aud_int'];
    ...
    protected function editRow()
    {
        ...
        // Check referential integrity for master table 'plano_auditoria_int'
        $detailKeys = [];
        $keyValue = $rsnew['plano_auditoria_int_idplano_auditoria_int'] ?? $rsold['plano_auditoria_int_idplano_auditoria_int'];
        $detailKeys['plano_auditoria_int_idplano_auditoria_int'] = $keyValue;
    ...
    protected function getEditRow($rsold)
    {
        ...
        // escopo
        $this->escopo->setDbValueDef($rsnew, $this->escopo->CurrentValue, $this->escopo->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['escopo'])) { // escopo
            $this->escopo->CurrentValue = $row['escopo'];
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "plano_auditoria_int") {
            $this->plano_auditoria_int_idplano_auditoria_int->Visible = true; // Need to insert foreign key
            $this->plano_auditoria_int_idplano_auditoria_int->CurrentValue = $this->plano_auditoria_int_idplano_auditoria_int->getSessionValue();
        }
