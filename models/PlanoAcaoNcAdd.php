 ...
 * Page class
 */
class PlanoAcaoNcAdd extends PlanoAcaoNc
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanoAcaoNcAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "PlanoAcaoNcAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "PlanoAcaoNcView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        $detailKeys = [];
        $detailKeys["nao_conformidade_idnao_conformidade"] = $this->nao_conformidade_idnao_conformidade->CurrentValue;
    ...
    protected function getAddRow()
    {
        ...
        // nao_conformidade_idnao_conformidade
        $this->nao_conformidade_idnao_conformidade->setDbValueDef($rsnew, $this->nao_conformidade_idnao_conformidade->CurrentValue, false);
