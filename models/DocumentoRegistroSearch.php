 ...
 * Page class
 */
class DocumentoRegistroSearch extends DocumentoRegistro
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentoRegistroSearch";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentoRegistroSearch";
    ...
    public function run()
    {
        ...
        if ($this->isSearch()) {
            ...
            if ($srchStr != "") {
                $srchStr = "DocumentoRegistroList" . "?" . $srchStr;
    ...
    {
        $srchUrl = "";
        $this->buildSearchUrl($srchUrl, $this->iddocumento_registro); // iddocumento_registro
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->iddocumento_registro->AdvancedSearch->SearchValue)) {
            $this->iddocumento_registro->addErrorMessage($this->iddocumento_registro->getErrorMessage(false));
        }
