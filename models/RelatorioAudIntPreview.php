 ...
 * Page class
 */
class RelatorioAudIntPreview extends RelatorioAudInt
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RelatorioAudIntPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "RelatorioAudIntPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "item_plano_aud_int") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=item_plano_aud_int&" . GetForeignKeyUrl("fk_iditem_plano_aud_int", $this->item_plano_aud_int_iditem_plano_aud_int->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "item_plano_aud_int") {
            $this->item_plano_aud_int_iditem_plano_aud_int->setQueryStringValue($keys[0] ?? "");
        }
    }
