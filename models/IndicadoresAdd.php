 ...
 * Page class
 */
class IndicadoresAdd extends Indicadores
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "IndicadoresAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "IndicadoresAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "IndicadoresView") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("graficos", $detailTblVar) && $detailPage->DetailAdd) {
            $detailPage->run();
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("GraficosGrid");
            if (in_array("graficos", $detailTblVar) && $detailPage->DetailAdd && $addRow) {
                $detailPage->indicadores_idindicadores->setSessionValue($this->idindicadores->CurrentValue); // Set master key
                $Security->loadCurrentUserLevel($this->ProjectID . "graficos"); // Load user level of detail table
                $addRow = $detailPage->gridInsert();
                $Security->loadCurrentUserLevel($this->ProjectID . $this->TableName); // Restore user level of master table
                if (!$addRow) {
                $detailPage->indicadores_idindicadores->setSessionValue(""); // Clear master key if insert failed
                }
            }
        }
