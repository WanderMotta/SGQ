 ...
 * Page class
 */
class AnaliseSwotView extends AnaliseSwot
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AnaliseSwotView";
    ...
    // CSS class/style
    public $CurrentPageName = "AnaliseSwotView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idanalise_swot") ?? Route("idanalise_swot")) !== null) {
            $this->RecKey["idanalise_swot"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idanalise_swot") ?? Route("idanalise_swot")) !== null) {
            ...
            $this->RecKey["idanalise_swot"] = $this->idanalise_swot->QueryStringValue;
        } elseif (Post("idanalise_swot") !== null) {
            $this->idanalise_swot->setFormValue(Post("idanalise_swot"));
            $this->RecKey["idanalise_swot"] = $this->idanalise_swot->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idanalise_swot->setQueryStringValue($keyValue);
            $this->RecKey["idanalise_swot"] = $this->idanalise_swot->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "AnaliseSwotList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("AnaliseSwotList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idanalise_swot->CurrentValue, $this->CurrentRow['idanalise_swot'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "AnaliseSwotList"; // No matching record, return to list
                    } else {
