 ...
 * Page class
 */
class ObjetivoQualidadeDelete extends ObjetivoQualidade
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ObjetivoQualidadeDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ObjetivoQualidadeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ObjetivoQualidadeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ObjetivoQualidadeList"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['idobjetivo_qualidade'];
