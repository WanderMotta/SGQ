 ...
 * Page class
 */
class RelatorioAudIntView extends RelatorioAudInt
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RelatorioAudIntView";
    ...
    // CSS class/style
    public $CurrentPageName = "RelatorioAudIntView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idrelatorio_aud_int") ?? Route("idrelatorio_aud_int")) !== null) {
            $this->RecKey["idrelatorio_aud_int"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idrelatorio_aud_int") ?? Route("idrelatorio_aud_int")) !== null) {
            ...
            $this->RecKey["idrelatorio_aud_int"] = $this->idrelatorio_aud_int->QueryStringValue;
        } elseif (Post("idrelatorio_aud_int") !== null) {
            $this->idrelatorio_aud_int->setFormValue(Post("idrelatorio_aud_int"));
            $this->RecKey["idrelatorio_aud_int"] = $this->idrelatorio_aud_int->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idrelatorio_aud_int->setQueryStringValue($keyValue);
            $this->RecKey["idrelatorio_aud_int"] = $this->idrelatorio_aud_int->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "RelatorioAudIntList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("RelatorioAudIntList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idrelatorio_aud_int->CurrentValue, $this->CurrentRow['idrelatorio_aud_int'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "RelatorioAudIntList"; // No matching record, return to list
                    } else {
