 ...
 * Page class
 */
class ItemRelAudInternaGrid extends ItemRelAudInterna
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemRelAudInternaGrid";
    ...
    public $FormName = "fitem_rel_aud_internagrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ItemRelAudInternaGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->iditem_rel_aud_interna->CurrentValue;
    ...
    public function emptyRow()
    {
        ...
        if (
            $CurrentForm->hasValue("x_acao_imediata") &&
            $CurrentForm->hasValue("o_acao_imediata") &&
            $this->acao_imediata->CurrentValue != $this->acao_imediata->DefaultValue &&
            !($this->acao_imediata->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->acao_imediata->CurrentValue == $this->acao_imediata->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_acao_contecao") &&
            $CurrentForm->hasValue("o_acao_contecao") &&
            $this->acao_contecao->CurrentValue != $this->acao_contecao->DefaultValue &&
            !($this->acao_contecao->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->acao_contecao->CurrentValue == $this->acao_contecao->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_abrir_nc") &&
            $CurrentForm->hasValue("o_abrir_nc") &&
            $this->abrir_nc->CurrentValue != $this->abrir_nc->DefaultValue &&
            !($this->abrir_nc->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->abrir_nc->CurrentValue == $this->abrir_nc->getSessionValue())
        ) {
            return false;
        }
        return true;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->iditem_rel_aud_interna->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
        ...
        if ($CurrentForm->hasValue("o_acao_imediata")) {
            $this->acao_imediata->setOldValue($CurrentForm->getValue("o_acao_imediata"));
        }
        ...
        if ($CurrentForm->hasValue("o_acao_contecao")) {
            $this->acao_contecao->setOldValue($CurrentForm->getValue("o_acao_contecao"));
        }
        ...
        if ($CurrentForm->hasValue("o_abrir_nc")) {
            $this->abrir_nc->setOldValue($CurrentForm->getValue("o_abrir_nc"));
        }
    }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['iditem_rel_aud_interna'];
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "relatorio_auditoria_interna") {
            $this->relatorio_auditoria_interna_idrelatorio_auditoria_interna->Visible = true; // Need to insert foreign key
            $this->relatorio_auditoria_interna_idrelatorio_auditoria_interna->CurrentValue = $this->relatorio_auditoria_interna_idrelatorio_auditoria_interna->getSessionValue();
        }
