 ...
 * Page class
 */
class AcaoRiscoOportunidadeView extends AcaoRiscoOportunidade
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AcaoRiscoOportunidadeView";
    ...
    // CSS class/style
    public $CurrentPageName = "AcaoRiscoOportunidadeView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idacao_risco_oportunidade") ?? Route("idacao_risco_oportunidade")) !== null) {
            $this->RecKey["idacao_risco_oportunidade"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idacao_risco_oportunidade") ?? Route("idacao_risco_oportunidade")) !== null) {
            ...
            $this->RecKey["idacao_risco_oportunidade"] = $this->idacao_risco_oportunidade->QueryStringValue;
        } elseif (Post("idacao_risco_oportunidade") !== null) {
            $this->idacao_risco_oportunidade->setFormValue(Post("idacao_risco_oportunidade"));
            $this->RecKey["idacao_risco_oportunidade"] = $this->idacao_risco_oportunidade->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idacao_risco_oportunidade->setQueryStringValue($keyValue);
            $this->RecKey["idacao_risco_oportunidade"] = $this->idacao_risco_oportunidade->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "AcaoRiscoOportunidadeList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("AcaoRiscoOportunidadeList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idacao_risco_oportunidade->CurrentValue, $this->CurrentRow['idacao_risco_oportunidade'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "AcaoRiscoOportunidadeList"; // No matching record, return to list
                    } else {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" form=\"facao_risco_oportunidadeview\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToExcel") . "</button>";
            } else {
                return "<a href=\"$exportUrl\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" form=\"facao_risco_oportunidadeview\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToWord") . "</button>";
            } else {
                return "<a href=\"$exportUrl\" class=\"btn btn-default ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPdf", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPdf", true)) . "\" form=\"facao_risco_oportunidadeview\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToPdf") . "</button>";
            } else {
