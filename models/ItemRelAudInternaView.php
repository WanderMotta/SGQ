 ...
 * Page class
 */
class ItemRelAudInternaView extends ItemRelAudInterna
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemRelAudInternaView";
    ...
    // CSS class/style
    public $CurrentPageName = "ItemRelAudInternaView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("iditem_rel_aud_interna") ?? Route("iditem_rel_aud_interna")) !== null) {
            $this->RecKey["iditem_rel_aud_interna"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("iditem_rel_aud_interna") ?? Route("iditem_rel_aud_interna")) !== null) {
            ...
            $this->RecKey["iditem_rel_aud_interna"] = $this->iditem_rel_aud_interna->QueryStringValue;
        } elseif (Post("iditem_rel_aud_interna") !== null) {
            $this->iditem_rel_aud_interna->setFormValue(Post("iditem_rel_aud_interna"));
            $this->RecKey["iditem_rel_aud_interna"] = $this->iditem_rel_aud_interna->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->iditem_rel_aud_interna->setQueryStringValue($keyValue);
            $this->RecKey["iditem_rel_aud_interna"] = $this->iditem_rel_aud_interna->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ItemRelAudInternaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ItemRelAudInternaList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->iditem_rel_aud_interna->CurrentValue, $this->CurrentRow['iditem_rel_aud_interna'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ItemRelAudInternaList"; // No matching record, return to list
                    } else {
