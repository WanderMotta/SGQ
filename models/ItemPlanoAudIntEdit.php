 ...
 * Page class
 */
class ItemPlanoAudIntEdit extends ItemPlanoAudInt
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemPlanoAudIntEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ItemPlanoAudIntEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("iditem_plano_aud_int") ?? Key(0) ?? Route(2)) !== null) {
                $this->iditem_plano_aud_int->setQueryStringValue($keyValue);
                $this->iditem_plano_aud_int->setOldValue($this->iditem_plano_aud_int->QueryStringValue);
            } elseif (Post("iditem_plano_aud_int") !== null) {
                $this->iditem_plano_aud_int->setFormValue(Post("iditem_plano_aud_int"));
                $this->iditem_plano_aud_int->setOldValue($this->iditem_plano_aud_int->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                if (($keyValue = Get("iditem_plano_aud_int") ?? Route("iditem_plano_aud_int")) !== null) {
                    ...
                    $this->iditem_plano_aud_int->CurrentValue = null;
                }
            }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->iditem_plano_aud_int->IsDetailKey) {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("relatorio_aud_int", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("RelatorioAudIntGrid");
            if (in_array("relatorio_aud_int", $detailTblVar) && $detailPage->DetailEdit && $editRow) {
