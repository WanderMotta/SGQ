 ...
 * Page class
 */
class ProcessoIndicadoresPreview extends ProcessoIndicadores
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProcessoIndicadoresPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ProcessoIndicadoresPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "processo") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=processo&" . GetForeignKeyUrl("fk_idprocesso", $this->processo_idprocesso->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "processo") {
            $this->processo_idprocesso->setQueryStringValue($keys[0] ?? "");
        }
    }
