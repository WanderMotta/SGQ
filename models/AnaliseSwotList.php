 ...
 * Page class
 */
class AnaliseSwotList extends AnaliseSwot
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AnaliseSwotList";
    ...
    public $FormName = "fanalise_swotlist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "AnaliseSwotList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "AnaliseSwotDelete";
        $this->MultiUpdateUrl = "AnaliseSwotUpdate";
        ...
        if (IsPost() && ($this->isGridUpdate() || $this->isMultiUpdate() || $this->isGridOverwrite()) && (Session(SESSION_INLINE_MODE) == "gridedit" || Session(SESSION_INLINE_MODE) == "multiedit")) {
            ...
            if ($gridUpdate) {
                ...
                if ($this->IsModal && !$this->UseAjaxActions) {
                    $this->terminate("AnaliseSwotList");
                    return;
                }
            } else {
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->idanalise_swot->AdvancedSearch->toJson(), ","); // Field idanalise_swot
        $filterList = Concat($filterList, $this->dt_cadastro->AdvancedSearch->toJson(), ","); // Field dt_cadastro
        $filterList = Concat($filterList, $this->fatores->AdvancedSearch->toJson(), ","); // Field fatores
        $filterList = Concat($filterList, $this->ponto->AdvancedSearch->toJson(), ","); // Field ponto
        $filterList = Concat($filterList, $this->analise->AdvancedSearch->toJson(), ","); // Field analise
        $filterList = Concat($filterList, $this->impacto_idimpacto->AdvancedSearch->toJson(), ","); // Field impacto_idimpacto
        $filterList = Concat($filterList, $this->contexto_idcontexto->AdvancedSearch->toJson(), ","); // Field contexto_idcontexto
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fanalise_swotsrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field idanalise_swot
        $this->idanalise_swot->AdvancedSearch->SearchValue = @$filter["x_idanalise_swot"];
        $this->idanalise_swot->AdvancedSearch->SearchOperator = @$filter["z_idanalise_swot"];
        $this->idanalise_swot->AdvancedSearch->SearchCondition = @$filter["v_idanalise_swot"];
        $this->idanalise_swot->AdvancedSearch->SearchValue2 = @$filter["y_idanalise_swot"];
        $this->idanalise_swot->AdvancedSearch->SearchOperator2 = @$filter["w_idanalise_swot"];
        $this->idanalise_swot->AdvancedSearch->save();
        ...
        // Field fatores
        $this->fatores->AdvancedSearch->SearchValue = @$filter["x_fatores"];
        $this->fatores->AdvancedSearch->SearchOperator = @$filter["z_fatores"];
        $this->fatores->AdvancedSearch->SearchCondition = @$filter["v_fatores"];
        $this->fatores->AdvancedSearch->SearchValue2 = @$filter["y_fatores"];
        $this->fatores->AdvancedSearch->SearchOperator2 = @$filter["w_fatores"];
        $this->fatores->AdvancedSearch->save();

        // Field ponto
        $this->ponto->AdvancedSearch->SearchValue = @$filter["x_ponto"];
        $this->ponto->AdvancedSearch->SearchOperator = @$filter["z_ponto"];
        $this->ponto->AdvancedSearch->SearchCondition = @$filter["v_ponto"];
        $this->ponto->AdvancedSearch->SearchValue2 = @$filter["y_ponto"];
        $this->ponto->AdvancedSearch->SearchOperator2 = @$filter["w_ponto"];
        $this->ponto->AdvancedSearch->save();

        // Field analise
        $this->analise->AdvancedSearch->SearchValue = @$filter["x_analise"];
        $this->analise->AdvancedSearch->SearchOperator = @$filter["z_analise"];
        $this->analise->AdvancedSearch->SearchCondition = @$filter["v_analise"];
        $this->analise->AdvancedSearch->SearchValue2 = @$filter["y_analise"];
        $this->analise->AdvancedSearch->SearchOperator2 = @$filter["w_analise"];
        $this->analise->AdvancedSearch->save();
        ...
        // Field contexto_idcontexto
        $this->contexto_idcontexto->AdvancedSearch->SearchValue = @$filter["x_contexto_idcontexto"];
        $this->contexto_idcontexto->AdvancedSearch->SearchOperator = @$filter["z_contexto_idcontexto"];
        $this->contexto_idcontexto->AdvancedSearch->SearchCondition = @$filter["v_contexto_idcontexto"];
        $this->contexto_idcontexto->AdvancedSearch->SearchValue2 = @$filter["y_contexto_idcontexto"];
        $this->contexto_idcontexto->AdvancedSearch->SearchOperator2 = @$filter["w_contexto_idcontexto"];
        $this->contexto_idcontexto->AdvancedSearch->save();
    ...
    public function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->idanalise_swot, $default, false); // idanalise_swot
        $this->buildSearchSql($where, $this->dt_cadastro, $default, false); // dt_cadastro
        $this->buildSearchSql($where, $this->fatores, $default, false); // fatores
        $this->buildSearchSql($where, $this->ponto, $default, false); // ponto
        $this->buildSearchSql($where, $this->analise, $default, false); // analise
        $this->buildSearchSql($where, $this->impacto_idimpacto, $default, false); // impacto_idimpacto
        $this->buildSearchSql($where, $this->contexto_idcontexto, $default, false); // contexto_idcontexto
        ...
        if (!$default && $this->Command == "search") {
            $this->idanalise_swot->AdvancedSearch->save(); // idanalise_swot
            $this->dt_cadastro->AdvancedSearch->save(); // dt_cadastro
            $this->fatores->AdvancedSearch->save(); // fatores
            $this->ponto->AdvancedSearch->save(); // ponto
            $this->analise->AdvancedSearch->save(); // analise
            $this->impacto_idimpacto->AdvancedSearch->save(); // impacto_idimpacto
            $this->contexto_idcontexto->AdvancedSearch->save(); // contexto_idcontexto
    ...
    public function showFilterList()
    {
        ...
        // Field fatores
        $filter = $this->queryBuilderWhere("fatores");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->fatores, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->fatores->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field ponto
        $filter = $this->queryBuilderWhere("ponto");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->ponto, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->ponto->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field analise
        $filter = $this->queryBuilderWhere("analise");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->analise, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->analise->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field impacto_idimpacto
        $filter = $this->queryBuilderWhere("impacto_idimpacto");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->impacto_idimpacto, false, false);
        }
        if ($filter != "") {
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->idanalise_swot->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->dt_cadastro->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->fatores->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->ponto->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->analise->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->impacto_idimpacto->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->contexto_idcontexto->AdvancedSearch->issetSession()) {
            return true;
        }
        return false;
    }
    ...
    {
        $this->idanalise_swot->AdvancedSearch->unsetSession();
        $this->dt_cadastro->AdvancedSearch->unsetSession();
        $this->fatores->AdvancedSearch->unsetSession();
        $this->ponto->AdvancedSearch->unsetSession();
        $this->analise->AdvancedSearch->unsetSession();
        $this->impacto_idimpacto->AdvancedSearch->unsetSession();
        $this->contexto_idcontexto->AdvancedSearch->unsetSession();
    }
    ...
    protected function restoreSearchParms()
    {
        ...
        $this->idanalise_swot->AdvancedSearch->load();
        $this->dt_cadastro->AdvancedSearch->load();
        $this->fatores->AdvancedSearch->load();
        $this->ponto->AdvancedSearch->load();
        $this->analise->AdvancedSearch->load();
        $this->impacto_idimpacto->AdvancedSearch->load();
        $this->contexto_idcontexto->AdvancedSearch->load();
    }
    ...
    public function renderListOptions()
    {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fanalise_swotlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fanalise_swotlist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->idanalise_swot->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "fatores");
            $this->createColumnOption($option, "ponto");
            $this->createColumnOption($option, "analise");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fanalise_swotsrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fanalise_swotsrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
        ...
        if (!$this->isGridAdd() && !$this->isGridEdit() && !$this->isMultiEdit()) { // Not grid add/grid edit/multi edit mode
            ...
            foreach ($this->ListActions as $listAction) {
                if ($listAction->Select == ACTION_MULTIPLE) {
                    ...
                    $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fanalise_swotlist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
            ...
            if ($this->isGridAdd()) {
                ...
                if (!($this->ModalGridAdd && !IsMobile())) {
                    ...
                    $item->Body = "<button class=\"ew-action ew-grid-insert\" title=\"" . HtmlTitle($Language->phrase("GridInsertLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("GridInsertLink")) . "\" form=\"fanalise_swotlist\" formaction=\"" . GetUrl($this->pageName()) . "\">" . $Language->phrase("GridInsertLink") . "</button>";
                    // Add grid cancel
            ...
            if ($this->isGridEdit()) {
                ...
                if (!($this->ModalGridEdit && !IsMobile())) {
                    ...
                    $option->UseDropDownButton = false;
                        ...
                        $item->Body = "<button class=\"ew-action ew-grid-save\" title=\"" . HtmlTitle($Language->phrase("GridSaveLink")) . "\" data-caption=\"" . HtmlTitle($Language->phrase("GridSaveLink")) . "\" form=\"fanalise_swotlist\" formaction=\"" . GetUrl($this->pageName()) . "\">" . $Language->phrase("GridSaveLink") . "</button>";
                        $item = &$option->add("gridcancel");
                        $cancelurl = $this->addMasterUrl($pageUrl . "action=cancel");
    ...
    protected function loadSearchValues()
    {
        ...
        // idanalise_swot
        if ($this->idanalise_swot->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->idanalise_swot->AdvancedSearch->SearchValue != "" || $this->idanalise_swot->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // fatores
        if ($this->fatores->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->fatores->AdvancedSearch->SearchValue != "" || $this->fatores->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // ponto
        if ($this->ponto->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->ponto->AdvancedSearch->SearchValue != "" || $this->ponto->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // analise
        if ($this->analise->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->analise->AdvancedSearch->SearchValue != "" || $this->analise->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // contexto_idcontexto
        if ($this->contexto_idcontexto->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->contexto_idcontexto->AdvancedSearch->SearchValue != "" || $this->contexto_idcontexto->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        return $hasValue;
    ...
    public function getRowHash($row)
    {
        ...
        $hash = "";
        $hash .= GetFieldHash($row['fatores']); // fatores
        $hash .= GetFieldHash($row['ponto']); // ponto
        $hash .= GetFieldHash($row['analise']); // analise
        $hash .= GetFieldHash($row['impacto_idimpacto']); // impacto_idimpacto
        return md5($hash);
    }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fanalise_swotlist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fanalise_swotsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
        ...
        if ($this->ModalSearch && !IsMobile()) {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch", true) . "\" data-table=\"analise_swot\" data-caption=\"" . $Language->phrase("AdvancedSearch", true) . "\" data-ew-action=\"modal\" data-url=\"AnaliseSwotSearch\" data-btn=\"SearchBtn\">" . $Language->phrase("AdvancedSearch", false) . "</a>";
        } else {
            $item->Body = "<a class=\"btn btn-default ew-advanced-search\" title=\"" . $Language->phrase("AdvancedSearch", true) . "\" data-caption=\"" . $Language->phrase("AdvancedSearch", true) . "\" href=\"AnaliseSwotSearch\">" . $Language->phrase("AdvancedSearch", false) . "</a>";
        }
        $item->Visible = true;

        // Search highlight button
        $item = &$this->SearchOptions->add("searchhighlight");
        $item->Body = "<a class=\"btn btn-default ew-highlight active\" role=\"button\" title=\"" . $Language->phrase("Highlight") . "\" data-caption=\"" . $Language->phrase("Highlight") . "\" data-ew-action=\"highlight\" data-form=\"fanalise_swotsrch\" data-name=\"" . $this->highlightName() . "\">" . $Language->phrase("HighlightBtn") . "</a>";
    ...
    */
    public function exportData($doc)
    {
        ...
        if (Config("EXPORT_MASTER_RECORD") && $this->DbMasterFilter != "" && $this->getCurrentMasterTable() == "contexto") {
            $contexto = new ContextoList();
            $rsmaster = $contexto->loadRs($this->DbMasterFilter); // Load master record
            if ($rsmaster) {
                $exportStyle = $doc->Style;
                $doc->setStyle("v"); // Change to vertical
                if (!$this->isExport("csv") || Config("EXPORT_MASTER_RECORD_FOR_CSV")) {
                    $doc->setTable($contexto);
                    $contexto->exportDocument($doc, $rsmaster);
                    $doc->exportEmptyRow();
                    $doc->setTable($this);
                }
