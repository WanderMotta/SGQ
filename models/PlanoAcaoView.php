 ...
 * Page class
 */
class PlanoAcaoView extends PlanoAcao
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PlanoAcaoView";
    ...
    // CSS class/style
    public $CurrentPageName = "PlanoAcaoView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idplano_acao") ?? Route("idplano_acao")) !== null) {
            $this->RecKey["idplano_acao"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idplano_acao") ?? Route("idplano_acao")) !== null) {
            ...
            $this->RecKey["idplano_acao"] = $this->idplano_acao->QueryStringValue;
        } elseif (Post("idplano_acao") !== null) {
            $this->idplano_acao->setFormValue(Post("idplano_acao"));
            $this->RecKey["idplano_acao"] = $this->idplano_acao->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idplano_acao->setQueryStringValue($keyValue);
            $this->RecKey["idplano_acao"] = $this->idplano_acao->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "PlanoAcaoList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("PlanoAcaoList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idplano_acao->CurrentValue, $this->CurrentRow['idplano_acao'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "PlanoAcaoList"; // No matching record, return to list
                    } else {
