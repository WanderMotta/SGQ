 ...
 * Page class
 */
class DocumentoInternoDelete extends DocumentoInterno
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentoInternoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentoInternoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DocumentoInternoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("DocumentoInternoList"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['iddocumento_interno'];
