 ...
 * Page class
 */
class AcaoRiscoOportunidadeSearch extends AcaoRiscoOportunidade
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AcaoRiscoOportunidadeSearch";
    ...
    // CSS class/style
    public $CurrentPageName = "AcaoRiscoOportunidadeSearch";
    ...
    public function run()
    {
        ...
        if ($this->isSearch()) {
            ...
            if ($srchStr != "") {
                $srchStr = "AcaoRiscoOportunidadeList" . "?" . $srchStr;
    ...
    {
        $srchUrl = "";
        $this->buildSearchUrl($srchUrl, $this->idacao_risco_oportunidade); // idacao_risco_oportunidade
        ...
        $this->buildSearchUrl($srchUrl, $this->acao); // acao
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->idacao_risco_oportunidade->EditValue = $this->idacao_risco_oportunidade->AdvancedSearch->SearchValue;
            $this->idacao_risco_oportunidade->PlaceHolder = RemoveHtml($this->idacao_risco_oportunidade->caption());
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->idacao_risco_oportunidade->AdvancedSearch->SearchValue)) {
            $this->idacao_risco_oportunidade->addErrorMessage($this->idacao_risco_oportunidade->getErrorMessage(false));
        }
