 ...
 * Page class
 */
class RelatorioAudIntGrid extends RelatorioAudInt
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RelatorioAudIntGrid";
    ...
    public $FormName = "frelatorio_aud_intgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "RelatorioAudIntGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->idrelatorio_aud_int->CurrentValue;
    ...
    public function emptyRow()
    {
        global $CurrentForm;
        if (
            $CurrentForm->hasValue("x_plano_auditoria_int_idplano_auditoria_int") &&
            $CurrentForm->hasValue("o_plano_auditoria_int_idplano_auditoria_int") &&
            $this->plano_auditoria_int_idplano_auditoria_int->CurrentValue != $this->plano_auditoria_int_idplano_auditoria_int->DefaultValue &&
            !($this->plano_auditoria_int_idplano_auditoria_int->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->plano_auditoria_int_idplano_auditoria_int->CurrentValue == $this->plano_auditoria_int_idplano_auditoria_int->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_item_plano_aud_int_iditem_plano_aud_int") &&
            $CurrentForm->hasValue("o_item_plano_aud_int_iditem_plano_aud_int") &&
            $this->item_plano_aud_int_iditem_plano_aud_int->CurrentValue != $this->item_plano_aud_int_iditem_plano_aud_int->DefaultValue &&
            !($this->item_plano_aud_int_iditem_plano_aud_int->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->item_plano_aud_int_iditem_plano_aud_int->CurrentValue == $this->item_plano_aud_int_iditem_plano_aud_int->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_metodo") &&
            $CurrentForm->hasValue("o_metodo") &&
            $this->metodo->CurrentValue != $this->metodo->DefaultValue &&
            !($this->metodo->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->metodo->CurrentValue == $this->metodo->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_descricao") &&
            $CurrentForm->hasValue("o_descricao") &&
            $this->descricao->CurrentValue != $this->descricao->DefaultValue &&
            !($this->descricao->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->descricao->CurrentValue == $this->descricao->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_evidencia") &&
            $CurrentForm->hasValue("o_evidencia") &&
            $this->evidencia->CurrentValue != $this->evidencia->DefaultValue &&
            !($this->evidencia->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->evidencia->CurrentValue == $this->evidencia->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_nao_conformidade") &&
            $CurrentForm->hasValue("o_nao_conformidade") &&
            $this->nao_conformidade->CurrentValue != $this->nao_conformidade->DefaultValue &&
            !($this->nao_conformidade->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->nao_conformidade->CurrentValue == $this->nao_conformidade->getSessionValue())
        ) {
            return false;
        }
        return true;
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_plano_auditoria_int_idplano_auditoria_int")) {
            $this->plano_auditoria_int_idplano_auditoria_int->setOldValue($CurrentForm->getValue("o_plano_auditoria_int_idplano_auditoria_int"));
        }
        ...
        if ($CurrentForm->hasValue("o_item_plano_aud_int_iditem_plano_aud_int")) {
            $this->item_plano_aud_int_iditem_plano_aud_int->setOldValue($CurrentForm->getValue("o_item_plano_aud_int_iditem_plano_aud_int"));
        }
        ...
        if ($CurrentForm->hasValue("o_metodo")) {
            $this->metodo->setOldValue($CurrentForm->getValue("o_metodo"));
        }
        ...
        if ($CurrentForm->hasValue("o_descricao")) {
            $this->descricao->setOldValue($CurrentForm->getValue("o_descricao"));
        }
        ...
        if ($CurrentForm->hasValue("o_evidencia")) {
            $this->evidencia->setOldValue($CurrentForm->getValue("o_evidencia"));
        }
        ...
        if ($CurrentForm->hasValue("o_nao_conformidade")) {
            $this->nao_conformidade->setOldValue($CurrentForm->getValue("o_nao_conformidade"));
        }
        ...
        if (!$this->idrelatorio_aud_int->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->item_plano_aud_int_iditem_plano_aud_int->getSessionValue() != "") {
                ...
                $this->item_plano_aud_int_iditem_plano_aud_int->OldValue = $this->item_plano_aud_int_iditem_plano_aud_int->CurrentValue;
                $this->item_plano_aud_int_iditem_plano_aud_int->ViewValue = $this->item_plano_aud_int_iditem_plano_aud_int->CurrentValue;
                $curVal = strval($this->item_plano_aud_int_iditem_plano_aud_int->CurrentValue);
                if ($curVal != "") {
                    $this->item_plano_aud_int_iditem_plano_aud_int->ViewValue = $this->item_plano_aud_int_iditem_plano_aud_int->lookupCacheOption($curVal);
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "item_plano_aud_int") {
            $this->item_plano_aud_int_iditem_plano_aud_int->Visible = true; // Need to insert foreign key
            $this->item_plano_aud_int_iditem_plano_aud_int->CurrentValue = $this->item_plano_aud_int_iditem_plano_aud_int->getSessionValue();
        }
    ...
    protected function setupMasterParms()
    {
        ...
        if ($masterTblVar == "item_plano_aud_int") {
            $masterTbl = Container("item_plano_aud_int");
            $this->item_plano_aud_int_iditem_plano_aud_int->Visible = false;
