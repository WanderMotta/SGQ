 ...
 * Page class
 */
class DocumentoRegistroView extends DocumentoRegistro
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentoRegistroView";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentoRegistroView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("iddocumento_registro") ?? Route("iddocumento_registro")) !== null) {
            $this->RecKey["iddocumento_registro"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("iddocumento_registro") ?? Route("iddocumento_registro")) !== null) {
            ...
            $this->RecKey["iddocumento_registro"] = $this->iddocumento_registro->QueryStringValue;
        } elseif (Post("iddocumento_registro") !== null) {
            $this->iddocumento_registro->setFormValue(Post("iddocumento_registro"));
            $this->RecKey["iddocumento_registro"] = $this->iddocumento_registro->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->iddocumento_registro->setQueryStringValue($keyValue);
            $this->RecKey["iddocumento_registro"] = $this->iddocumento_registro->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "DocumentoRegistroList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("DocumentoRegistroList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->iddocumento_registro->CurrentValue, $this->CurrentRow['iddocumento_registro'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "DocumentoRegistroList"; // No matching record, return to list
                    } else {
