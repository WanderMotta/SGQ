 ...
 * Page class
 */
class ProcessoIndicadoresAdd extends ProcessoIndicadores
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ProcessoIndicadoresAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ProcessoIndicadoresAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ProcessoIndicadoresView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        $detailKeys = [];
        $detailKeys["processo_idprocesso"] = $this->processo_idprocesso->CurrentValue;
