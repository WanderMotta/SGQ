 ...
 * Page class
 */
class FrequenciaView extends Frequencia
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "FrequenciaView";
    ...
    // CSS class/style
    public $CurrentPageName = "FrequenciaView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idfrequencia") ?? Route("idfrequencia")) !== null) {
            $this->RecKey["idfrequencia"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idfrequencia") ?? Route("idfrequencia")) !== null) {
            ...
            $this->RecKey["idfrequencia"] = $this->idfrequencia->QueryStringValue;
        } elseif (Post("idfrequencia") !== null) {
            $this->idfrequencia->setFormValue(Post("idfrequencia"));
            $this->RecKey["idfrequencia"] = $this->idfrequencia->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idfrequencia->setQueryStringValue($keyValue);
            $this->RecKey["idfrequencia"] = $this->idfrequencia->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "FrequenciaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("FrequenciaList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idfrequencia->CurrentValue, $this->CurrentRow['idfrequencia'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "FrequenciaList"; // No matching record, return to list
                    } else {
