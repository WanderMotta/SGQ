 ...
 * Page class
 */
class DocumentoExternoView extends DocumentoExterno
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DocumentoExternoView";
    ...
    // CSS class/style
    public $CurrentPageName = "DocumentoExternoView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("iddocumento_externo") ?? Route("iddocumento_externo")) !== null) {
            $this->RecKey["iddocumento_externo"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("iddocumento_externo") ?? Route("iddocumento_externo")) !== null) {
            ...
            $this->RecKey["iddocumento_externo"] = $this->iddocumento_externo->QueryStringValue;
        } elseif (Post("iddocumento_externo") !== null) {
            $this->iddocumento_externo->setFormValue(Post("iddocumento_externo"));
            $this->RecKey["iddocumento_externo"] = $this->iddocumento_externo->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->iddocumento_externo->setQueryStringValue($keyValue);
            $this->RecKey["iddocumento_externo"] = $this->iddocumento_externo->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "DocumentoExternoList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("DocumentoExternoList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->iddocumento_externo->CurrentValue, $this->CurrentRow['iddocumento_externo'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "DocumentoExternoList"; // No matching record, return to list
                    } else {
