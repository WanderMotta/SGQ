 ...
 * Page class
 */
class RelatorioAuditoriaInternaView extends RelatorioAuditoriaInterna
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RelatorioAuditoriaInternaView";
    ...
    // CSS class/style
    public $CurrentPageName = "RelatorioAuditoriaInternaView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idrelatorio_auditoria_interna") ?? Route("idrelatorio_auditoria_interna")) !== null) {
            $this->RecKey["idrelatorio_auditoria_interna"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idrelatorio_auditoria_interna") ?? Route("idrelatorio_auditoria_interna")) !== null) {
            ...
            $this->RecKey["idrelatorio_auditoria_interna"] = $this->idrelatorio_auditoria_interna->QueryStringValue;
            ...
            $this->RecKey["idrelatorio_auditoria_interna"] = $this->idrelatorio_auditoria_interna->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idrelatorio_auditoria_interna->setQueryStringValue($keyValue);
            $this->RecKey["idrelatorio_auditoria_interna"] = $this->idrelatorio_auditoria_interna->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "RelatorioAuditoriaInternaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("RelatorioAuditoriaInternaList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idrelatorio_auditoria_interna->CurrentValue, $this->CurrentRow['idrelatorio_auditoria_interna'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "RelatorioAuditoriaInternaList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $item = &$option->add("detail_item_rel_aud_interna");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->tablePhrase("item_rel_aud_interna", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ItemRelAudInternaList?" . Config("TABLE_SHOW_MASTER") . "=relatorio_auditoria_interna&" . GetForeignKeyUrl("fk_idrelatorio_auditoria_interna", $this->idrelatorio_auditoria_interna->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("ItemRelAudInternaGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'relatorio_auditoria_interna')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=item_rel_aud_interna"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
            $detailViewTblVar .= "item_rel_aud_interna";
        }
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'relatorio_auditoria_interna')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=item_rel_aud_interna"))) . "\">" . $Language->phrase("MasterDetailEditLink", null) . "</a></li>";
            if ($detailEditTblVar != "") {
                $detailEditTblVar .= ",";
            }
            $detailEditTblVar .= "item_rel_aud_interna";
        }
        if ($detailPageObj->DetailAdd && $Security->canAdd() && $Security->allowAdd(CurrentProjectID() . 'relatorio_auditoria_interna')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-copy\" data-action=\"add\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailCopyLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getCopyUrl(Config("TABLE_SHOW_DETAIL") . "=item_rel_aud_interna"))) . "\">" . $Language->phrase("MasterDetailCopyLink", null) . "</a></li>";
            if ($detailCopyTblVar != "") {
                $detailCopyTblVar .= ",";
            }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" form=\"frelatorio_auditoria_internaview\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToExcel") . "</button>";
            } else {
                return "<a href=\"$exportUrl\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" form=\"frelatorio_auditoria_internaview\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToWord") . "</button>";
            } else {
                return "<a href=\"$exportUrl\" class=\"btn btn-default ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPdf", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPdf", true)) . "\" form=\"frelatorio_auditoria_internaview\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToPdf") . "</button>";
            } else {
    ...
    */
    public function exportData($doc, $keys)
    {
        ...
        // Export detail records (item_rel_aud_interna)
        if (Config("EXPORT_DETAIL_RECORDS") && in_array("item_rel_aud_interna", explode(",", $this->getCurrentDetailTable()))) {
            $item_rel_aud_interna = new ItemRelAudInternaList();
            $rsdetail = $item_rel_aud_interna->loadRs($item_rel_aud_interna->getDetailFilterFromSession(), $item_rel_aud_interna->getSessionOrderBy()); // Load detail records
            if ($rsdetail) {
                ...
                if (!$this->isExport("csv") || Config("EXPORT_DETAIL_RECORDS_FOR_CSV")) {
                    ...
                    $oldtbl = $doc->getTable();
                    $doc->setTable($item_rel_aud_interna);
                    $item_rel_aud_interna->exportDocument($doc, $rsdetail, 1, $detailcnt);
                    $doc->setTable($oldtbl);
                }
