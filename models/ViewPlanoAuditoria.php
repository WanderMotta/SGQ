...
/**
 * Table class for view_plano_auditoria
 */
class ViewPlanoAuditoria extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_plano_auditoria";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->idplano_auditoria_int = new DbField(
            $this, // Table
        ...
        $this->idplano_auditoria_int->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['idplano_auditoria_int'] = &$this->idplano_auditoria_int;

        // aud lider
        $this->audlider = new DbField(
            $this, // Table
        ...
        $this->processo->Lookup = new Lookup($this->processo, 'view_plano_auditoria', true, 'processo', ["processo","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    public function insert(&$rs)
    {
        ...
        if ($result) {
            $this->idplano_auditoria_int->setDbValue($conn->lastInsertId());
            $rs['idplano_auditoria_int'] = $this->idplano_auditoria_int->DbValue;
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['idplano_auditoria_int']) && !EmptyValue($this->idplano_auditoria_int->CurrentValue)) {
                $rs['idplano_auditoria_int'] = $this->idplano_auditoria_int->CurrentValue;
            }
        }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('idplano_auditoria_int', $rs)) {
                AddFilter($where, QuotedName('idplano_auditoria_int', $this->Dbid) . '=' . QuotedValue($rs['idplano_auditoria_int'], $this->idplano_auditoria_int->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->idplano_auditoria_int->DbValue = $row['idplano_auditoria_int'];
        $this->audlider->DbValue = $row['aud lider'];
        $this->criterio->DbValue = $row['criterio'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPlanoAuditoriaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewPlanoAuditoriaView" => $Language->phrase("View"),
            "ViewPlanoAuditoriaEdit" => $Language->phrase("Edit"),
            "ViewPlanoAuditoriaAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewPlanoAuditoriaView",
            Config("API_ADD_ACTION") => "ViewPlanoAuditoriaAdd",
            Config("API_EDIT_ACTION") => "ViewPlanoAuditoriaEdit",
            Config("API_DELETE_ACTION") => "ViewPlanoAuditoriaDelete",
            Config("API_LIST_ACTION") => "ViewPlanoAuditoriaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPlanoAuditoriaView", $parm);
        } else {
            $url = $this->keyUrl("ViewPlanoAuditoriaView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewPlanoAuditoriaAdd?" . $parm;
        } else {
            $url = "ViewPlanoAuditoriaAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPlanoAuditoriaEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPlanoAuditoriaList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPlanoAuditoriaAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPlanoAuditoriaList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewPlanoAuditoriaDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ViewPlanoAuditoriaList";
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->audlider->Raw) {
            $this->audlider->CurrentValue = HtmlDecode($this->audlider->CurrentValue);
        }
        $this->audlider->EditValue = $this->audlider->CurrentValue;
        $this->audlider->PlaceHolder = RemoveHtml($this->audlider->caption());

        // criterio
        $this->criterio->setupEditAttributes();
        $this->criterio->EditValue = $this->criterio->CurrentValue;
        ...
        $this->iditem_plano_aud_int->PlaceHolder = RemoveHtml($this->iditem_plano_aud_int->caption());
        if (strval($this->iditem_plano_aud_int->EditValue) != "" && is_numeric($this->iditem_plano_aud_int->EditValue)) {
            $this->iditem_plano_aud_int->EditValue = $this->iditem_plano_aud_int->EditValue;
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->idplano_auditoria_int);
                    $doc->exportCaption($this->audlider);
                    $doc->exportCaption($this->criterio);
        ...
        while (($row = $result->fetch()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->idplano_auditoria_int);
                        $doc->exportField($this->audlider);
                        $doc->exportField($this->criterio);
