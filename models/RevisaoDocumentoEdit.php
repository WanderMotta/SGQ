 ...
 * Page class
 */
class RevisaoDocumentoEdit extends RevisaoDocumento
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RevisaoDocumentoEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "RevisaoDocumentoEdit";
    ...
    public function run()
    {
        ...
        $this->setVisibility();
        $this->status_documento_idstatus_documento->Required = false;
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("idrevisao_documento") ?? Key(0) ?? Route(2)) !== null) {
                $this->idrevisao_documento->setQueryStringValue($keyValue);
                $this->idrevisao_documento->setOldValue($this->idrevisao_documento->QueryStringValue);
            } elseif (Post("idrevisao_documento") !== null) {
                $this->idrevisao_documento->setFormValue(Post("idrevisao_documento"));
                $this->idrevisao_documento->setOldValue($this->idrevisao_documento->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                if (($keyValue = Get("idrevisao_documento") ?? Route("idrevisao_documento")) !== null) {
                    ...
                    $this->idrevisao_documento->CurrentValue = null;
                }
            }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->idrevisao_documento->IsDetailKey) {
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            if ($this->idrevisao_documento->Visible && $this->idrevisao_documento->Required) {
                if (!$this->idrevisao_documento->IsDetailKey && EmptyValue($this->idrevisao_documento->FormValue)) {
                    $this->idrevisao_documento->addErrorMessage(str_replace("%s", $this->idrevisao_documento->caption(), $this->idrevisao_documento->RequiredErrorMessage));
                }
            }
    ...
    protected function getEditRow($rsold)
    {
        ...
        // documento_interno_iddocumento_interno
        if ($this->documento_interno_iddocumento_interno->getSessionValue() != "") {
            $this->documento_interno_iddocumento_interno->ReadOnly = true;
        }
        $this->documento_interno_iddocumento_interno->setDbValueDef($rsnew, $this->documento_interno_iddocumento_interno->CurrentValue, $this->documento_interno_iddocumento_interno->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        if (isset($row['documento_interno_iddocumento_interno'])) { // documento_interno_iddocumento_interno
            $this->documento_interno_iddocumento_interno->CurrentValue = $row['documento_interno_iddocumento_interno'];
        }
