 ...
 * Page class
 */
class AnaliseSwotPreview extends AnaliseSwot
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AnaliseSwotPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "AnaliseSwotPreview";
    ...
    protected function setupSortOrder()
    {
        ...
        if (SameText(Get("cmd"), "resetsort")) {
            ...
            $this->idanalise_swot->setSort("");
            $this->dt_cadastro->setSort("");
            $this->fatores->setSort("");
            $this->ponto->setSort("");
            $this->analise->setSort("");
            $this->impacto_idimpacto->setSort("");
            $this->contexto_idcontexto->setSort("");
        ...
        if ($this->CurrentOrder !== "") {
            $this->updateSort($this->fatores, $ctrl); // fatores
            $this->updateSort($this->ponto, $ctrl); // ponto
            $this->updateSort($this->analise, $ctrl); // analise
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "contexto") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=contexto&" . GetForeignKeyUrl("fk_idcontexto", $this->contexto_idcontexto->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "contexto") {
            $this->contexto_idcontexto->setQueryStringValue($keys[0] ?? "");
        }
    }
