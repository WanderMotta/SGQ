 ...
 * Page class
 */
class RelatorioAuditoriaInternaDelete extends RelatorioAuditoriaInterna
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "RelatorioAuditoriaInternaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "RelatorioAuditoriaInternaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("RelatorioAuditoriaInternaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("RelatorioAuditoriaInternaList"); // Return to list
                return;
            }
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['idrelatorio_auditoria_interna'];
