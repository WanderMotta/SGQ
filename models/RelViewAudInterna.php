...
/**
 * Table class for rel_view_aud_interna
 */
class RelViewAudInterna extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->ReportSourceTable = 'view_relatoria_auditoria'; // Report source table
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->plano_nr->GroupingFieldId = 1;
        $this->plano_nr->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->plano_nr->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->plano_nr->GroupByType = "";
        $this->plano_nr->GroupInterval = "0";
        $this->plano_nr->GroupSql = "";
        $this->plano_nr->IsAutoIncrement = true; // Autoincrement field
        $this->plano_nr->IsPrimaryKey = true; // Primary key field
        $this->plano_nr->setSelectMultiple(false); // Select one
        $this->plano_nr->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->plano_nr->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->plano_nr->Lookup = new Lookup($this->plano_nr, 'view_relatoria_auditoria', true, 'plano_nr', ["plano_nr","","",""], '', '', [], [], [], [], [], [], false, '`plano_nr` DESC', '', "`plano_nr`");
        $this->plano_nr->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->plano_nr->SearchOperators = ["=", "<>", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->plano_nr->SourceTableVar = 'view_relatoria_auditoria';
        $this->plano_nr->SearchType = "dropdown";
        ...
        $this->data->Raw = true;
        $this->data->GroupingFieldId = 2;
        $this->data->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->data->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->data->GroupByType = "";
        $this->data->GroupInterval = "0";
        $this->data->GroupSql = "";
        ...
        $this->data->SourceTableVar = 'view_relatoria_auditoria';
        $this->Fields['data'] = &$this->data;

        // auditor_lider
        $this->auditor_lider = new ReportField(
            $this, // Table
        ...
        $this->auditor_lider->GroupingFieldId = 3;
        $this->auditor_lider->ShowGroupHeaderAsRow = $this->ShowGroupHeaderAsRow;
        $this->auditor_lider->ShowCompactSummaryFooter = $this->ShowCompactSummaryFooter;
        $this->auditor_lider->GroupByType = "";
        $this->auditor_lider->GroupInterval = "0";
        $this->auditor_lider->GroupSql = "";
        ...
        $this->auditor_lider->SourceTableVar = 'view_relatoria_auditoria';
        ...
        $this->processo->SourceTableVar = 'view_relatoria_auditoria';
        ...
        $this->auditor->SourceTableVar = 'view_relatoria_auditoria';
        $this->Fields['auditor'] = &$this->auditor;

        // metodo
        $this->metodo = new ReportField(
            $this, // Table
        ...
        $this->metodo->Lookup = new Lookup($this->metodo, 'rel_view_aud_interna', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->metodo->OptionCount = 3;
        $this->metodo->SearchOperators = ["=", "<>"];
        $this->metodo->SourceTableVar = 'view_relatoria_auditoria';
        ...
        $this->escopo->SourceTableVar = 'view_relatoria_auditoria';
        ...
        $this->descricao->SourceTableVar = 'view_relatoria_auditoria';
        $this->Fields['descricao'] = &$this->descricao;

        // evidencia
        $this->evidencia = new ReportField(
            $this, // Table
        ...
        $this->evidencia->SourceTableVar = 'view_relatoria_auditoria';
        $this->Fields['evidencia'] = &$this->evidencia;

        // nao_conformidade
        $this->nao_conformidade = new ReportField(
            $this, // Table
        ...
        $this->nao_conformidade->Lookup = new Lookup($this->nao_conformidade, 'rel_view_aud_interna', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->nao_conformidade->OptionCount = 2;
        $this->nao_conformidade->SearchOperators = ["=", "<>"];
        $this->nao_conformidade->SourceTableVar = 'view_relatoria_auditoria';
        ...
        $this->item->SourceTableVar = 'view_relatoria_auditoria';
    ...
    {
        return $this->sqlSelectAggregate ?? $this->getQueryBuilder()->select("COUNT(*) AS cnt_processo");
    }
    ...
    {
        $this->plano_nr->ViewValue = GetDropDownDisplayValue($this->plano_nr->CurrentValue, "", 0);
    }
    ...
    public function getSqlSelect()
    {
        ...
        $groupField = &$this->data;
        if ($groupField->GroupSql != "") {
            $expr = str_replace("%s", $groupField->Expression, $groupField->GroupSql) . " AS " . QuotedName($groupField->getGroupName(), $this->Dbid);
            $select->addSelect($expr);
        }
        $groupField = &$this->auditor_lider;
        if ($groupField->GroupSql != "") {
            $expr = str_replace("%s", $groupField->Expression, $groupField->GroupSql) . " AS " . QuotedName($groupField->getGroupName(), $this->Dbid);
            $select->addSelect($expr);
        }
    ...
    {
        return "RelViewAudInterna";
    }

    // API page name
    public function getApiPageName($action)
    {
        return "RelViewAudInternaSummary";
    }
