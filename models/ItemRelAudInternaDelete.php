 ...
 * Page class
 */
class ItemRelAudInternaDelete extends ItemRelAudInterna
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ItemRelAudInternaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ItemRelAudInternaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ItemRelAudInternaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ItemRelAudInternaList"); // Return to list
                return;
            }
        }
