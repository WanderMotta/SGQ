 ...
 * Page class
 */
class ImpactoView extends Impacto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ImpactoView";
    ...
    // CSS class/style
    public $CurrentPageName = "ImpactoView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idimpacto") ?? Route("idimpacto")) !== null) {
            $this->RecKey["idimpacto"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idimpacto") ?? Route("idimpacto")) !== null) {
            ...
            $this->RecKey["idimpacto"] = $this->idimpacto->QueryStringValue;
        } elseif (Post("idimpacto") !== null) {
            $this->idimpacto->setFormValue(Post("idimpacto"));
            $this->RecKey["idimpacto"] = $this->idimpacto->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idimpacto->setQueryStringValue($keyValue);
            $this->RecKey["idimpacto"] = $this->idimpacto->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ImpactoList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ImpactoList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idimpacto->CurrentValue, $this->CurrentRow['idimpacto'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ImpactoList"; // No matching record, return to list
                    } else {
