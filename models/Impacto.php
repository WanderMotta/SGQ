...
/**
 * Table class for impacto
 */
class Impacto extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // idimpacto
        $this->idimpacto = new DbField(
            $this, // Table
            'x_idimpacto', // Variable name
            'idimpacto', // Name
            '`idimpacto`', // Expression
            '`idimpacto`', // Basic search expression
            19, // Type
            2, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`idimpacto`', // Virtual expression
            false, // Is virtual
        ...
        $this->idimpacto->InputTextType = "text";
        $this->idimpacto->Raw = true;
        $this->idimpacto->IsAutoIncrement = true; // Autoincrement field
        $this->idimpacto->IsPrimaryKey = true; // Primary key field
        $this->idimpacto->Nullable = false; // NOT NULL field
        $this->idimpacto->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->idimpacto->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['idimpacto'] = &$this->idimpacto;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "impacto";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($result) {
            $this->idimpacto->setDbValue($conn->lastInsertId());
            $rs['idimpacto'] = $this->idimpacto->DbValue;
        }
        return $result;
    }
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['idimpacto']) && !EmptyValue($this->idimpacto->CurrentValue)) {
                $rs['idimpacto'] = $this->idimpacto->CurrentValue;
            }
        }
        return $success;
    }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('idimpacto', $rs)) {
                AddFilter($where, QuotedName('idimpacto', $this->Dbid) . '=' . QuotedValue($rs['idimpacto'], $this->idimpacto->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->idimpacto->DbValue = $row['idimpacto'];
    ...
    {
        $keys = [];
        $val = $current ? $this->idimpacto->CurrentValue : $this->idimpacto->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->idimpacto->CurrentValue = $keys[0];
            } else {
                $this->idimpacto->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('idimpacto', $row) ? $row['idimpacto'] : null;
        } else {
            $val = !EmptyValue($this->idimpacto->OldValue) && !$current ? $this->idimpacto->OldValue : $this->idimpacto->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@idimpacto@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ImpactoList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ImpactoView" => $Language->phrase("View"),
            "ImpactoEdit" => $Language->phrase("Edit"),
            "ImpactoAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ImpactoView",
            Config("API_ADD_ACTION") => "ImpactoAdd",
            Config("API_EDIT_ACTION") => "ImpactoEdit",
            Config("API_DELETE_ACTION") => "ImpactoDelete",
            Config("API_LIST_ACTION") => "ImpactoList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ImpactoView", $parm);
        } else {
            $url = $this->keyUrl("ImpactoView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ImpactoEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ImpactoList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ImpactoAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ImpactoList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ImpactoDelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"idimpacto\":" . VarToJson($this->idimpacto->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->idimpacto->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->idimpacto->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("idimpacto") ?? Route("idimpacto")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->idimpacto->CurrentValue = $key;
            } else {
                $this->idimpacto->OldValue = $key;
            }
    ...
    public function renderEditRow()
    {
        ...
        $this->idimpacto->EditValue = $this->idimpacto->CurrentValue;
        ...
        if (!$this->impacto->Raw) {
            $this->impacto->CurrentValue = HtmlDecode($this->impacto->CurrentValue);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    $doc->exportCaption($this->idimpacto);
        ...
        while (($row = $result->fetch()) && $recCnt < $stopRec) {
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        $doc->exportField($this->idimpacto);
