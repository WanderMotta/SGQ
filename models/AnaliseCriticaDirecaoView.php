 ...
 * Page class
 */
class AnaliseCriticaDirecaoView extends AnaliseCriticaDirecao
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AnaliseCriticaDirecaoView";
    ...
    // CSS class/style
    public $CurrentPageName = "AnaliseCriticaDirecaoView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("idanalise_critica_direcao") ?? Route("idanalise_critica_direcao")) !== null) {
            $this->RecKey["idanalise_critica_direcao"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("idanalise_critica_direcao") ?? Route("idanalise_critica_direcao")) !== null) {
            ...
            $this->RecKey["idanalise_critica_direcao"] = $this->idanalise_critica_direcao->QueryStringValue;
        } elseif (Post("idanalise_critica_direcao") !== null) {
            $this->idanalise_critica_direcao->setFormValue(Post("idanalise_critica_direcao"));
            $this->RecKey["idanalise_critica_direcao"] = $this->idanalise_critica_direcao->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->idanalise_critica_direcao->setQueryStringValue($keyValue);
            $this->RecKey["idanalise_critica_direcao"] = $this->idanalise_critica_direcao->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "AnaliseCriticaDirecaoList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("AnaliseCriticaDirecaoList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->idanalise_critica_direcao->CurrentValue, $this->CurrentRow['idanalise_critica_direcao'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "AnaliseCriticaDirecaoList"; // No matching record, return to list
                    } else {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" form=\"fanalise_critica_direcaoview\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"excel\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToExcel") . "</button>";
            } else {
                return "<a href=\"$exportUrl\" class=\"btn btn-default ew-export-link ew-excel\" title=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToExcel", true)) . "\">" . $Language->phrase("ExportToExcel") . "</a>";
            }
        } elseif (SameText($type, "word")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" form=\"fanalise_critica_direcaoview\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"word\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToWord") . "</button>";
            } else {
                return "<a href=\"$exportUrl\" class=\"btn btn-default ew-export-link ew-word\" title=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToWord", true)) . "\">" . $Language->phrase("ExportToWord") . "</a>";
            }
        } elseif (SameText($type, "pdf")) {
            if ($custom) {
                return "<button type=\"button\" class=\"btn btn-default ew-export-link ew-pdf\" title=\"" . HtmlEncode($Language->phrase("ExportToPdf", true)) . "\" data-caption=\"" . HtmlEncode($Language->phrase("ExportToPdf", true)) . "\" form=\"fanalise_critica_direcaoview\" data-url=\"$exportUrl\" data-ew-action=\"export\" data-export=\"pdf\" data-custom=\"true\" data-export-selected=\"false\">" . $Language->phrase("ExportToPdf") . "</button>";
            } else {
