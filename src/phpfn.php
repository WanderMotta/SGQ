...
Type::addType("geometry", "PHPMaker2024\\sgq\\GeometryType"); // "geometry" type
Type::addType("geography", "PHPMaker2024\\sgq\\GeographyType"); // "geography" type
Type::addType("hierarchyid", "PHPMaker2024\\sgq\\HierarchyIdType"); // "hierarchyid" type
Type::addType("bytes", "PHPMaker2024\\sgq\\BytesType"); // "bytes" type
...
{
    $criteria = array_merge(["login" => $username], $criteria);
