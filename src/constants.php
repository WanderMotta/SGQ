...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "24.12.0");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "sgq"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{E0FBA0D0-6EA0-4AAB-A8CC-5871C01EDF16}"); // Project ID
